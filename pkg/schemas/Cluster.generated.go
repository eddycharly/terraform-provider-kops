...
func Cluster() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"kube_certificate_authority":        ComputedString(),
			"kube_client_certificate":           ComputedString(),
			"kube_client_key":                   ComputedString(),
			"kube_username":                     ComputedString(),
			"kube_password":                     ComputedString(),
