...
func ConfigConfigRollingUpdate() *schema.Resource {
...
func ExpandConfigConfigRollingUpdate(in map[string]interface{}) config.RollingUpdate {
	if in == nil {
...
func FlattenConfigConfigRollingUpdateInto(in config.RollingUpdate, out map[string]interface{}) {
...
func FlattenConfigConfigRollingUpdate(in config.RollingUpdate) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenConfigConfigRollingUpdateInto(in, out)
	return out
}
