...
func ConfigConfigValidate() *schema.Resource {
...
func ExpandConfigConfigValidate(in map[string]interface{}) config.Validate {
	if in == nil {
...
func FlattenConfigConfigValidateInto(in config.Validate, out map[string]interface{}) {
...
func FlattenConfigConfigValidate(in config.Validate) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenConfigConfigValidateInto(in, out)
	return out
}
