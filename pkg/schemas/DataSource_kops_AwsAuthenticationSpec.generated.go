...
func DataSourceKopsAwsAuthenticationSpec() *schema.Resource {
...
func ExpandDataSourceKopsAwsAuthenticationSpec(in map[string]interface{}) kops.AwsAuthenticationSpec {
	if in == nil {
...
func FlattenDataSourceKopsAwsAuthenticationSpecInto(in kops.AwsAuthenticationSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsAwsAuthenticationSpec(in kops.AwsAuthenticationSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsAwsAuthenticationSpecInto(in, out)
	return out
}
