...
func DataSourceKopsBastionSpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"bastion_public_name":  ComputedString(),
			"idle_timeout_seconds": ComputedInt(),
			"load_balancer":        ComputedStruct(DataSourceKopsBastionLoadBalancerSpec()),
		},
	}
}

func ExpandDataSourceKopsBastionSpec(in map[string]interface{}) kops.BastionSpec {
	if in == nil {
		...
		LoadBalancer: func(in interface{}) *kops.BastionLoadBalancerSpec {
			return func(in interface{}) *kops.BastionLoadBalancerSpec {
				...
				return func(in kops.BastionLoadBalancerSpec) *kops.BastionLoadBalancerSpec {
					...
					return (ExpandDataSourceKopsBastionLoadBalancerSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["load_balancer"]),
	}
...
func FlattenDataSourceKopsBastionSpecInto(in kops.BastionSpec, out map[string]interface{}) {
		...
		return func(in *kops.BastionLoadBalancerSpec) interface{} {
			...
			return func(in kops.BastionLoadBalancerSpec) interface{} {
				return func(in kops.BastionLoadBalancerSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsBastionLoadBalancerSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.LoadBalancer)
...
func FlattenDataSourceKopsBastionSpec(in kops.BastionSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsBastionSpecInto(in, out)
	return out
}
