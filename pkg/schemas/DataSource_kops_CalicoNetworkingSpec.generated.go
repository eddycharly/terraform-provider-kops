...
func DataSourceKopsCalicoNetworkingSpec() *schema.Resource {
...
func ExpandDataSourceKopsCalicoNetworkingSpec(in map[string]interface{}) kops.CalicoNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceKopsCalicoNetworkingSpecInto(in kops.CalicoNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsCalicoNetworkingSpec(in kops.CalicoNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsCalicoNetworkingSpecInto(in, out)
	return out
}
