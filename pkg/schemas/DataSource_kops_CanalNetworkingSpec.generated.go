...
func DataSourceKopsCanalNetworkingSpec() *schema.Resource {
...
func ExpandDataSourceKopsCanalNetworkingSpec(in map[string]interface{}) kops.CanalNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceKopsCanalNetworkingSpecInto(in kops.CanalNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsCanalNetworkingSpec(in kops.CanalNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsCanalNetworkingSpecInto(in, out)
	return out
}
