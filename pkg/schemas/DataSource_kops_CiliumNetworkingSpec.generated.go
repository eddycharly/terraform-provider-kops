...
func DataSourceKopsCiliumNetworkingSpec() *schema.Resource {
...
func ExpandDataSourceKopsCiliumNetworkingSpec(in map[string]interface{}) kops.CiliumNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceKopsCiliumNetworkingSpecInto(in kops.CiliumNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsCiliumNetworkingSpec(in kops.CiliumNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsCiliumNetworkingSpecInto(in, out)
	return out
}
