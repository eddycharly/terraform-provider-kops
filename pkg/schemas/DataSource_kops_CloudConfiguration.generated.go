...
func DataSourceKopsCloudConfiguration() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"openstack":                      ComputedStruct(DataSourceKopsOpenstackConfiguration()),
		},
	}
}

func ExpandDataSourceKopsCloudConfiguration(in map[string]interface{}) kops.CloudConfiguration {
	if in == nil {
		...
		Openstack: func(in interface{}) *kops.OpenstackConfiguration {
			return func(in interface{}) *kops.OpenstackConfiguration {
				...
				return func(in kops.OpenstackConfiguration) *kops.OpenstackConfiguration {
					...
					return (ExpandDataSourceKopsOpenstackConfiguration(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["openstack"]),
	}
...
func FlattenDataSourceKopsCloudConfigurationInto(in kops.CloudConfiguration, out map[string]interface{}) {
		...
		return func(in *kops.OpenstackConfiguration) interface{} {
			...
			return func(in kops.OpenstackConfiguration) interface{} {
				return func(in kops.OpenstackConfiguration) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsOpenstackConfiguration(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Openstack)
...
func FlattenDataSourceKopsCloudConfiguration(in kops.CloudConfiguration) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsCloudConfigurationInto(in, out)
	return out
}
