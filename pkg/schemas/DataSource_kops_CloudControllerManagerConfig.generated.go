...
func DataSourceKopsCloudControllerManagerConfig() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"leader_election":                 ComputedStruct(DataSourceKopsLeaderElectionConfiguration()),
			"use_service_account_credentials": ComputedBool(),
		},
	}
}

func ExpandDataSourceKopsCloudControllerManagerConfig(in map[string]interface{}) kops.CloudControllerManagerConfig {
	if in == nil {
		...
		LeaderElection: func(in interface{}) *kops.LeaderElectionConfiguration {
			return func(in interface{}) *kops.LeaderElectionConfiguration {
				...
				return func(in kops.LeaderElectionConfiguration) *kops.LeaderElectionConfiguration {
					...
					return (ExpandDataSourceKopsLeaderElectionConfiguration(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["leader_election"]),
...
func FlattenDataSourceKopsCloudControllerManagerConfigInto(in kops.CloudControllerManagerConfig, out map[string]interface{}) {
		...
		return func(in *kops.LeaderElectionConfiguration) interface{} {
			...
			return func(in kops.LeaderElectionConfiguration) interface{} {
				return func(in kops.LeaderElectionConfiguration) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsLeaderElectionConfiguration(in)}
				}(in)
			}(*in)
		}(in)
	}(in.LeaderElection)
...
func FlattenDataSourceKopsCloudControllerManagerConfig(in kops.CloudControllerManagerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsCloudControllerManagerConfigInto(in, out)
	return out
}
