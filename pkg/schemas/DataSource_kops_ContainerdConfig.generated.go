...
func DataSourceKopsContainerdConfig() *schema.Resource {
...
func ExpandDataSourceKopsContainerdConfig(in map[string]interface{}) kops.ContainerdConfig {
	if in == nil {
...
func FlattenDataSourceKopsContainerdConfigInto(in kops.ContainerdConfig, out map[string]interface{}) {
...
func FlattenDataSourceKopsContainerdConfig(in kops.ContainerdConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsContainerdConfigInto(in, out)
	return out
}
