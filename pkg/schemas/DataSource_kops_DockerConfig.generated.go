...
func DataSourceKopsDockerConfig() *schema.Resource {
...
func ExpandDataSourceKopsDockerConfig(in map[string]interface{}) kops.DockerConfig {
	if in == nil {
...
func FlattenDataSourceKopsDockerConfigInto(in kops.DockerConfig, out map[string]interface{}) {
...
func FlattenDataSourceKopsDockerConfig(in kops.DockerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsDockerConfigInto(in, out)
	return out
}
