...
func DataSourceKopsEtcdClusterSpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"name":                    ComputedString(),
			"provider":                ComputedString(),
			"members":                 ComputedList(DataSourceKopsEtcdMemberSpec()),
			...
			"backups":                 ComputedStruct(DataSourceKopsEtcdBackupSpec()),
			"manager":                 ComputedStruct(DataSourceKopsEtcdManagerSpec()),
...
func ExpandDataSourceKopsEtcdClusterSpec(in map[string]interface{}) kops.EtcdClusterSpec {
	if in == nil {
				...
				for _, in := range in.([]interface{}) {
					out = append(out, func(in interface{}) *kops.EtcdMemberSpec {
						...
						return func(in kops.EtcdMemberSpec) *kops.EtcdMemberSpec {
							...
							return (ExpandDataSourceKopsEtcdMemberSpec(in.(map[string]interface{})))
						}(in))
					}(in))
				}
				return out
		...
		Backups: func(in interface{}) *kops.EtcdBackupSpec {
			return func(in interface{}) *kops.EtcdBackupSpec {
				...
				return func(in kops.EtcdBackupSpec) *kops.EtcdBackupSpec {
					...
					return (ExpandDataSourceKopsEtcdBackupSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["backups"]),
		Manager: func(in interface{}) *kops.EtcdManagerSpec {
			return func(in interface{}) *kops.EtcdManagerSpec {
				...
				return func(in kops.EtcdManagerSpec) *kops.EtcdManagerSpec {
					...
					return (ExpandDataSourceKopsEtcdManagerSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["manager"]),
...
func FlattenDataSourceKopsEtcdClusterSpecInto(in kops.EtcdClusterSpec, out map[string]interface{}) {
		...
		return func(in []*kops.EtcdMemberSpec) []interface{} {
			...
			for _, in := range in {
				out = append(out, func(in *kops.EtcdMemberSpec) interface{} {
					...
					return func(in kops.EtcdMemberSpec) interface{} {
						return func(in kops.EtcdMemberSpec) interface{} {
							return FlattenDataSourceKopsEtcdMemberSpec(in)
						}(in)
					}(*in)
				}(in))
			}
		...
		return func(in *kops.EtcdBackupSpec) interface{} {
			...
			return func(in kops.EtcdBackupSpec) interface{} {
				return func(in kops.EtcdBackupSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsEtcdBackupSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Backups)
		...
		return func(in *kops.EtcdManagerSpec) interface{} {
			...
			return func(in kops.EtcdManagerSpec) interface{} {
				return func(in kops.EtcdManagerSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsEtcdManagerSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Manager)
...
func FlattenDataSourceKopsEtcdClusterSpec(in kops.EtcdClusterSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsEtcdClusterSpecInto(in, out)
	return out
}
