...
func DataSourceKopsEtcdMemberSpec() *schema.Resource {
...
func ExpandDataSourceKopsEtcdMemberSpec(in map[string]interface{}) kops.EtcdMemberSpec {
	if in == nil {
...
func FlattenDataSourceKopsEtcdMemberSpecInto(in kops.EtcdMemberSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsEtcdMemberSpec(in kops.EtcdMemberSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsEtcdMemberSpecInto(in, out)
	return out
}
