...
func DataSourceKopsFileAssetSpec() *schema.Resource {
...
func ExpandDataSourceKopsFileAssetSpec(in map[string]interface{}) kops.FileAssetSpec {
	if in == nil {
...
func FlattenDataSourceKopsFileAssetSpecInto(in kops.FileAssetSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsFileAssetSpec(in kops.FileAssetSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsFileAssetSpecInto(in, out)
	return out
}
