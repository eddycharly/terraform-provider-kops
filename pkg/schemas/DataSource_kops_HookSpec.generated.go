...
func DataSourceKopsHookSpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"exec_container":   ComputedStruct(DataSourceKopsExecContainerAction()),
...
func ExpandDataSourceKopsHookSpec(in map[string]interface{}) kops.HookSpec {
	if in == nil {
		...
		ExecContainer: func(in interface{}) *kops.ExecContainerAction {
			return func(in interface{}) *kops.ExecContainerAction {
				...
				return func(in kops.ExecContainerAction) *kops.ExecContainerAction {
					...
					return (ExpandDataSourceKopsExecContainerAction(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["exec_container"]),
...
func FlattenDataSourceKopsHookSpecInto(in kops.HookSpec, out map[string]interface{}) {
		...
		return func(in *kops.ExecContainerAction) interface{} {
			...
			return func(in kops.ExecContainerAction) interface{} {
				return func(in kops.ExecContainerAction) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsExecContainerAction(in)}
				}(in)
			}(*in)
		}(in)
	}(in.ExecContainer)
...
func FlattenDataSourceKopsHookSpec(in kops.HookSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsHookSpecInto(in, out)
	return out
}
