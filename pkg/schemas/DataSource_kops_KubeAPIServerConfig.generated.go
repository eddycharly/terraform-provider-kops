...
func DataSourceKopsKubeAPIServerConfig() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"http_2max_streams_per_connection":             ComputedInt(),
...
func ExpandDataSourceKopsKubeAPIServerConfig(in map[string]interface{}) kops.KubeAPIServerConfig {
	if in == nil {
...
func FlattenDataSourceKopsKubeAPIServerConfigInto(in kops.KubeAPIServerConfig, out map[string]interface{}) {
...
func FlattenDataSourceKopsKubeAPIServerConfig(in kops.KubeAPIServerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsKubeAPIServerConfigInto(in, out)
	return out
}
