...
func DataSourceKopsKubeControllerManagerConfig() *schema.Resource {
...
func ExpandDataSourceKopsKubeControllerManagerConfig(in map[string]interface{}) kops.KubeControllerManagerConfig {
	if in == nil {
...
func FlattenDataSourceKopsKubeControllerManagerConfigInto(in kops.KubeControllerManagerConfig, out map[string]interface{}) {
...
func FlattenDataSourceKopsKubeControllerManagerConfig(in kops.KubeControllerManagerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsKubeControllerManagerConfigInto(in, out)
	return out
}
