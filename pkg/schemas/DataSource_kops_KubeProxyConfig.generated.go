...
func DataSourceKopsKubeProxyConfig() *schema.Resource {
...
func ExpandDataSourceKopsKubeProxyConfig(in map[string]interface{}) kops.KubeProxyConfig {
	if in == nil {
...
func FlattenDataSourceKopsKubeProxyConfigInto(in kops.KubeProxyConfig, out map[string]interface{}) {
...
func FlattenDataSourceKopsKubeProxyConfig(in kops.KubeProxyConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsKubeProxyConfigInto(in, out)
	return out
}
