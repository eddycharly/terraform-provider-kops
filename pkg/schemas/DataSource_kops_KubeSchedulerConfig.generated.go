...
func DataSourceKopsKubeSchedulerConfig() *schema.Resource {
...
func ExpandDataSourceKopsKubeSchedulerConfig(in map[string]interface{}) kops.KubeSchedulerConfig {
	if in == nil {
...
func FlattenDataSourceKopsKubeSchedulerConfigInto(in kops.KubeSchedulerConfig, out map[string]interface{}) {
...
func FlattenDataSourceKopsKubeSchedulerConfig(in kops.KubeSchedulerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsKubeSchedulerConfigInto(in, out)
	return out
}
