...
func DataSourceKopsKubeletConfigSpec() *schema.Resource {
...
func ExpandDataSourceKopsKubeletConfigSpec(in map[string]interface{}) kops.KubeletConfigSpec {
	if in == nil {
...
func FlattenDataSourceKopsKubeletConfigSpecInto(in kops.KubeletConfigSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsKubeletConfigSpec(in kops.KubeletConfigSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsKubeletConfigSpecInto(in, out)
	return out
}
