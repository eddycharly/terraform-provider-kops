...
func DataSourceKopsLeaderElectionConfiguration() *schema.Resource {
...
func ExpandDataSourceKopsLeaderElectionConfiguration(in map[string]interface{}) kops.LeaderElectionConfiguration {
	if in == nil {
...
func FlattenDataSourceKopsLeaderElectionConfigurationInto(in kops.LeaderElectionConfiguration, out map[string]interface{}) {
...
func FlattenDataSourceKopsLeaderElectionConfiguration(in kops.LeaderElectionConfiguration) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsLeaderElectionConfigurationInto(in, out)
	return out
}
