...
func DataSourceKopsLoadBalancerAccessSpec() *schema.Resource {
...
func ExpandDataSourceKopsLoadBalancerAccessSpec(in map[string]interface{}) kops.LoadBalancerAccessSpec {
	if in == nil {
...
func FlattenDataSourceKopsLoadBalancerAccessSpecInto(in kops.LoadBalancerAccessSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsLoadBalancerAccessSpec(in kops.LoadBalancerAccessSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsLoadBalancerAccessSpecInto(in, out)
	return out
}
