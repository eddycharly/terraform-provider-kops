...
func DataSourceKopsMixedInstancesPolicySpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"instances":                     ComputedList(String()),
			"on_demand_allocation_strategy": ComputedString(),
			"on_demand_base":                ComputedInt(),
			"on_demand_above_base":          ComputedInt(),
...
func ExpandDataSourceKopsMixedInstancesPolicySpec(in map[string]interface{}) kops.MixedInstancesPolicySpec {
	if in == nil {
...
func FlattenDataSourceKopsMixedInstancesPolicySpecInto(in kops.MixedInstancesPolicySpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsMixedInstancesPolicySpec(in kops.MixedInstancesPolicySpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsMixedInstancesPolicySpecInto(in, out)
	return out
}
