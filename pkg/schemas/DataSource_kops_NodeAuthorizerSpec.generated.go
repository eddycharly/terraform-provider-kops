...
func DataSourceKopsNodeAuthorizerSpec() *schema.Resource {
...
func ExpandDataSourceKopsNodeAuthorizerSpec(in map[string]interface{}) kops.NodeAuthorizerSpec {
	if in == nil {
...
func FlattenDataSourceKopsNodeAuthorizerSpecInto(in kops.NodeAuthorizerSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsNodeAuthorizerSpec(in kops.NodeAuthorizerSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsNodeAuthorizerSpecInto(in, out)
	return out
}
