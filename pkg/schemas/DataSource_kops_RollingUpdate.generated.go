...
func DataSourceKopsRollingUpdate() *schema.Resource {
...
func ExpandDataSourceKopsRollingUpdate(in map[string]interface{}) kops.RollingUpdate {
	if in == nil {
...
func FlattenDataSourceKopsRollingUpdateInto(in kops.RollingUpdate, out map[string]interface{}) {
...
func FlattenDataSourceKopsRollingUpdate(in kops.RollingUpdate) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsRollingUpdateInto(in, out)
	return out
}
