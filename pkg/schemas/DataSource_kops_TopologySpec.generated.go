...
func DataSourceKopsTopologySpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"masters": ComputedString(),
			"nodes":   ComputedString(),
			"bastion": ComputedStruct(DataSourceKopsBastionSpec()),
			"dns":     ComputedStruct(DataSourceKopsDNSSpec()),
		},
	}
}

func ExpandDataSourceKopsTopologySpec(in map[string]interface{}) kops.TopologySpec {
	if in == nil {
		...
		Bastion: func(in interface{}) *kops.BastionSpec {
			return func(in interface{}) *kops.BastionSpec {
				...
				return func(in kops.BastionSpec) *kops.BastionSpec {
					...
					return (ExpandDataSourceKopsBastionSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["bastion"]),
		DNS: func(in interface{}) *kops.DNSSpec {
			return func(in interface{}) *kops.DNSSpec {
				...
				return func(in kops.DNSSpec) *kops.DNSSpec {
					...
					return (ExpandDataSourceKopsDNSSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["dns"]),
	}
...
func FlattenDataSourceKopsTopologySpecInto(in kops.TopologySpec, out map[string]interface{}) {
		...
		return func(in *kops.BastionSpec) interface{} {
			...
			return func(in kops.BastionSpec) interface{} {
				return func(in kops.BastionSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsBastionSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Bastion)
		...
		return func(in *kops.DNSSpec) interface{} {
			...
			return func(in kops.DNSSpec) interface{} {
				return func(in kops.DNSSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenDataSourceKopsDNSSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.DNS)
...
func FlattenDataSourceKopsTopologySpec(in kops.TopologySpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsTopologySpecInto(in, out)
	return out
}
