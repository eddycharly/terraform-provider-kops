...
func DataSourceKopsVolumeMountSpec() *schema.Resource {
...
func ExpandDataSourceKopsVolumeMountSpec(in map[string]interface{}) kops.VolumeMountSpec {
	if in == nil {
...
func FlattenDataSourceKopsVolumeMountSpecInto(in kops.VolumeMountSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsVolumeMountSpec(in kops.VolumeMountSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsVolumeMountSpecInto(in, out)
	return out
}
