...
func DataSourceKopsVolumeSpec() *schema.Resource {
...
func ExpandDataSourceKopsVolumeSpec(in map[string]interface{}) kops.VolumeSpec {
	if in == nil {
...
func FlattenDataSourceKopsVolumeSpecInto(in kops.VolumeSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsVolumeSpec(in kops.VolumeSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsVolumeSpecInto(in, out)
	return out
}
