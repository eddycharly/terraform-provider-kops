...
func DataSourceKopsWeaveNetworkingSpec() *schema.Resource {
...
func ExpandDataSourceKopsWeaveNetworkingSpec(in map[string]interface{}) kops.WeaveNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceKopsWeaveNetworkingSpecInto(in kops.WeaveNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceKopsWeaveNetworkingSpec(in kops.WeaveNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKopsWeaveNetworkingSpecInto(in, out)
	return out
}
