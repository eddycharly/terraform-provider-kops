...
func ExpandDataSourceKubeConfig(in map[string]interface{}) kube.Config {
	if in == nil {
...
func FlattenDataSourceKubeConfigInto(in kube.Config, out map[string]interface{}) {
...
func FlattenDataSourceKubeConfig(in kube.Config) map[string]interface{} {
