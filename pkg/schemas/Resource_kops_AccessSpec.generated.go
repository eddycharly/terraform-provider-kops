...
func ResourceKopsAccessSpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"dns":           OptionalStruct(ResourceKopsDNSAccessSpec()),
			"load_balancer": OptionalStruct(ResourceKopsLoadBalancerAccessSpec()),
		},
	}
}

func ExpandResourceKopsAccessSpec(in map[string]interface{}) kops.AccessSpec {
	if in == nil {
		...
		DNS: func(in interface{}) *kops.DNSAccessSpec {
			return func(in interface{}) *kops.DNSAccessSpec {
				...
				return func(in kops.DNSAccessSpec) *kops.DNSAccessSpec {
					...
					return (ExpandResourceKopsDNSAccessSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["dns"]),
		LoadBalancer: func(in interface{}) *kops.LoadBalancerAccessSpec {
			return func(in interface{}) *kops.LoadBalancerAccessSpec {
				...
				return func(in kops.LoadBalancerAccessSpec) *kops.LoadBalancerAccessSpec {
					...
					return (ExpandResourceKopsLoadBalancerAccessSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["load_balancer"]),
	}
...
func FlattenResourceKopsAccessSpecInto(in kops.AccessSpec, out map[string]interface{}) {
		...
		return func(in *kops.DNSAccessSpec) interface{} {
			...
			return func(in kops.DNSAccessSpec) interface{} {
				return func(in kops.DNSAccessSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsDNSAccessSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.DNS)
		...
		return func(in *kops.LoadBalancerAccessSpec) interface{} {
			...
			return func(in kops.LoadBalancerAccessSpec) interface{} {
				return func(in kops.LoadBalancerAccessSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsLoadBalancerAccessSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.LoadBalancer)
...
func FlattenResourceKopsAccessSpec(in kops.AccessSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsAccessSpecInto(in, out)
	return out
}
