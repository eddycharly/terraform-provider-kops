...
func ResourceKopsAwsAuthenticationSpec() *schema.Resource {
...
func ExpandResourceKopsAwsAuthenticationSpec(in map[string]interface{}) kops.AwsAuthenticationSpec {
	if in == nil {
...
func FlattenResourceKopsAwsAuthenticationSpecInto(in kops.AwsAuthenticationSpec, out map[string]interface{}) {
...
func FlattenResourceKopsAwsAuthenticationSpec(in kops.AwsAuthenticationSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsAwsAuthenticationSpecInto(in, out)
	return out
}
