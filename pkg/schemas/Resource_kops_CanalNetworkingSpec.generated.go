...
func ResourceKopsCanalNetworkingSpec() *schema.Resource {
...
func ExpandResourceKopsCanalNetworkingSpec(in map[string]interface{}) kops.CanalNetworkingSpec {
	if in == nil {
...
func FlattenResourceKopsCanalNetworkingSpecInto(in kops.CanalNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceKopsCanalNetworkingSpec(in kops.CanalNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsCanalNetworkingSpecInto(in, out)
	return out
}
