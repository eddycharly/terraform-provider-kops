...
func ResourceKopsCiliumNetworkingSpec() *schema.Resource {
...
func ExpandResourceKopsCiliumNetworkingSpec(in map[string]interface{}) kops.CiliumNetworkingSpec {
	if in == nil {
...
func FlattenResourceKopsCiliumNetworkingSpecInto(in kops.CiliumNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceKopsCiliumNetworkingSpec(in kops.CiliumNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsCiliumNetworkingSpecInto(in, out)
	return out
}
