...
func ResourceKopsCloudConfiguration() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"openstack":                      OptionalStruct(ResourceKopsOpenstackConfiguration()),
		},
	}
}

func ExpandResourceKopsCloudConfiguration(in map[string]interface{}) kops.CloudConfiguration {
	if in == nil {
		...
		Openstack: func(in interface{}) *kops.OpenstackConfiguration {
			return func(in interface{}) *kops.OpenstackConfiguration {
				...
				return func(in kops.OpenstackConfiguration) *kops.OpenstackConfiguration {
					...
					return (ExpandResourceKopsOpenstackConfiguration(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["openstack"]),
	}
...
func FlattenResourceKopsCloudConfigurationInto(in kops.CloudConfiguration, out map[string]interface{}) {
		...
		return func(in *kops.OpenstackConfiguration) interface{} {
			...
			return func(in kops.OpenstackConfiguration) interface{} {
				return func(in kops.OpenstackConfiguration) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsOpenstackConfiguration(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Openstack)
...
func FlattenResourceKopsCloudConfiguration(in kops.CloudConfiguration) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsCloudConfigurationInto(in, out)
	return out
}
