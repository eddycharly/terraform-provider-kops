...
func ResourceKopsCloudControllerManagerConfig() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"leader_election":                 OptionalStruct(ResourceKopsLeaderElectionConfiguration()),
			"use_service_account_credentials": OptionalBool(),
		},
	}
}

func ExpandResourceKopsCloudControllerManagerConfig(in map[string]interface{}) kops.CloudControllerManagerConfig {
	if in == nil {
		...
		LeaderElection: func(in interface{}) *kops.LeaderElectionConfiguration {
			return func(in interface{}) *kops.LeaderElectionConfiguration {
				...
				return func(in kops.LeaderElectionConfiguration) *kops.LeaderElectionConfiguration {
					...
					return (ExpandResourceKopsLeaderElectionConfiguration(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["leader_election"]),
...
func FlattenResourceKopsCloudControllerManagerConfigInto(in kops.CloudControllerManagerConfig, out map[string]interface{}) {
		...
		return func(in *kops.LeaderElectionConfiguration) interface{} {
			...
			return func(in kops.LeaderElectionConfiguration) interface{} {
				return func(in kops.LeaderElectionConfiguration) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsLeaderElectionConfiguration(in)}
				}(in)
			}(*in)
		}(in)
	}(in.LeaderElection)
...
func FlattenResourceKopsCloudControllerManagerConfig(in kops.CloudControllerManagerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsCloudControllerManagerConfigInto(in, out)
	return out
}
