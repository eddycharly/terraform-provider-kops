...
func ResourceKopsClusterSubnetSpec() *schema.Resource {
...
func ExpandResourceKopsClusterSubnetSpec(in map[string]interface{}) kops.ClusterSubnetSpec {
	if in == nil {
...
func FlattenResourceKopsClusterSubnetSpecInto(in kops.ClusterSubnetSpec, out map[string]interface{}) {
...
func FlattenResourceKopsClusterSubnetSpec(in kops.ClusterSubnetSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsClusterSubnetSpecInto(in, out)
	return out
}
