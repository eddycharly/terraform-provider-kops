...
func ResourceKopsContainerdConfig() *schema.Resource {
...
func ExpandResourceKopsContainerdConfig(in map[string]interface{}) kops.ContainerdConfig {
	if in == nil {
...
func FlattenResourceKopsContainerdConfigInto(in kops.ContainerdConfig, out map[string]interface{}) {
...
func FlattenResourceKopsContainerdConfig(in kops.ContainerdConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsContainerdConfigInto(in, out)
	return out
}
