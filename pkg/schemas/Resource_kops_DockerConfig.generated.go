...
func ResourceKopsDockerConfig() *schema.Resource {
...
func ExpandResourceKopsDockerConfig(in map[string]interface{}) kops.DockerConfig {
	if in == nil {
...
func FlattenResourceKopsDockerConfigInto(in kops.DockerConfig, out map[string]interface{}) {
...
func FlattenResourceKopsDockerConfig(in kops.DockerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsDockerConfigInto(in, out)
	return out
}
