...
func ResourceKopsEtcdClusterSpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"name":                    RequiredString(),
			"provider":                OptionalString(),
			"members":                 RequiredList(ResourceKopsEtcdMemberSpec()),
			...
			"backups":                 OptionalStruct(ResourceKopsEtcdBackupSpec()),
			"manager":                 OptionalStruct(ResourceKopsEtcdManagerSpec()),
...
func ExpandResourceKopsEtcdClusterSpec(in map[string]interface{}) kops.EtcdClusterSpec {
	if in == nil {
				...
				for _, in := range in.([]interface{}) {
					out = append(out, func(in interface{}) *kops.EtcdMemberSpec {
						...
						return func(in kops.EtcdMemberSpec) *kops.EtcdMemberSpec {
							...
							return (ExpandResourceKopsEtcdMemberSpec(in.(map[string]interface{})))
						}(in))
					}(in))
				}
				return out
		...
		Backups: func(in interface{}) *kops.EtcdBackupSpec {
			return func(in interface{}) *kops.EtcdBackupSpec {
				...
				return func(in kops.EtcdBackupSpec) *kops.EtcdBackupSpec {
					...
					return (ExpandResourceKopsEtcdBackupSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["backups"]),
		Manager: func(in interface{}) *kops.EtcdManagerSpec {
			return func(in interface{}) *kops.EtcdManagerSpec {
				...
				return func(in kops.EtcdManagerSpec) *kops.EtcdManagerSpec {
					...
					return (ExpandResourceKopsEtcdManagerSpec(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["manager"]),
...
func FlattenResourceKopsEtcdClusterSpecInto(in kops.EtcdClusterSpec, out map[string]interface{}) {
		...
		return func(in []*kops.EtcdMemberSpec) []interface{} {
			...
			for _, in := range in {
				out = append(out, func(in *kops.EtcdMemberSpec) interface{} {
					...
					return func(in kops.EtcdMemberSpec) interface{} {
						return func(in kops.EtcdMemberSpec) interface{} {
							return FlattenResourceKopsEtcdMemberSpec(in)
						}(in)
					}(*in)
				}(in))
			}
		...
		return func(in *kops.EtcdBackupSpec) interface{} {
			...
			return func(in kops.EtcdBackupSpec) interface{} {
				return func(in kops.EtcdBackupSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsEtcdBackupSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Backups)
		...
		return func(in *kops.EtcdManagerSpec) interface{} {
			...
			return func(in kops.EtcdManagerSpec) interface{} {
				return func(in kops.EtcdManagerSpec) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsEtcdManagerSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Manager)
...
func FlattenResourceKopsEtcdClusterSpec(in kops.EtcdClusterSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsEtcdClusterSpecInto(in, out)
	return out
}
