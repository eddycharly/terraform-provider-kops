...
func ResourceKopsEtcdMemberSpec() *schema.Resource {
...
func ExpandResourceKopsEtcdMemberSpec(in map[string]interface{}) kops.EtcdMemberSpec {
	if in == nil {
...
func FlattenResourceKopsEtcdMemberSpecInto(in kops.EtcdMemberSpec, out map[string]interface{}) {
...
func FlattenResourceKopsEtcdMemberSpec(in kops.EtcdMemberSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsEtcdMemberSpecInto(in, out)
	return out
}
