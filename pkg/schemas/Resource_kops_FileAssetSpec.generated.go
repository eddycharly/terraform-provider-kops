...
func ResourceKopsFileAssetSpec() *schema.Resource {
...
func ExpandResourceKopsFileAssetSpec(in map[string]interface{}) kops.FileAssetSpec {
	if in == nil {
...
func FlattenResourceKopsFileAssetSpecInto(in kops.FileAssetSpec, out map[string]interface{}) {
...
func FlattenResourceKopsFileAssetSpec(in kops.FileAssetSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsFileAssetSpecInto(in, out)
	return out
}
