...
func ResourceKopsFlannelNetworkingSpec() *schema.Resource {
...
func ExpandResourceKopsFlannelNetworkingSpec(in map[string]interface{}) kops.FlannelNetworkingSpec {
	if in == nil {
...
func FlattenResourceKopsFlannelNetworkingSpecInto(in kops.FlannelNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceKopsFlannelNetworkingSpec(in kops.FlannelNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsFlannelNetworkingSpecInto(in, out)
	return out
}
