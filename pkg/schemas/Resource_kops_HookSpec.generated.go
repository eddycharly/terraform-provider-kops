...
func ResourceKopsHookSpec() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"exec_container":   OptionalStruct(ResourceKopsExecContainerAction()),
...
func ExpandResourceKopsHookSpec(in map[string]interface{}) kops.HookSpec {
	if in == nil {
		...
		ExecContainer: func(in interface{}) *kops.ExecContainerAction {
			return func(in interface{}) *kops.ExecContainerAction {
				...
				return func(in kops.ExecContainerAction) *kops.ExecContainerAction {
					...
					return (ExpandResourceKopsExecContainerAction(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["exec_container"]),
...
func FlattenResourceKopsHookSpecInto(in kops.HookSpec, out map[string]interface{}) {
		...
		return func(in *kops.ExecContainerAction) interface{} {
			...
			return func(in kops.ExecContainerAction) interface{} {
				return func(in kops.ExecContainerAction) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsExecContainerAction(in)}
				}(in)
			}(*in)
		}(in)
	}(in.ExecContainer)
...
func FlattenResourceKopsHookSpec(in kops.HookSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsHookSpecInto(in, out)
	return out
}
