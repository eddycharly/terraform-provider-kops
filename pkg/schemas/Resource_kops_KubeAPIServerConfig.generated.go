...
func ResourceKopsKubeAPIServerConfig() *schema.Resource {
...
func ExpandResourceKopsKubeAPIServerConfig(in map[string]interface{}) kops.KubeAPIServerConfig {
	if in == nil {
...
func FlattenResourceKopsKubeAPIServerConfigInto(in kops.KubeAPIServerConfig, out map[string]interface{}) {
...
func FlattenResourceKopsKubeAPIServerConfig(in kops.KubeAPIServerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsKubeAPIServerConfigInto(in, out)
	return out
}
