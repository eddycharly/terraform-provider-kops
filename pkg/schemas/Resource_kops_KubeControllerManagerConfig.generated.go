...
func ResourceKopsKubeControllerManagerConfig() *schema.Resource {
...
func ExpandResourceKopsKubeControllerManagerConfig(in map[string]interface{}) kops.KubeControllerManagerConfig {
	if in == nil {
...
func FlattenResourceKopsKubeControllerManagerConfigInto(in kops.KubeControllerManagerConfig, out map[string]interface{}) {
...
func FlattenResourceKopsKubeControllerManagerConfig(in kops.KubeControllerManagerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsKubeControllerManagerConfigInto(in, out)
	return out
}
