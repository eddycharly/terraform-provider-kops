...
func ResourceKopsKubeProxyConfig() *schema.Resource {
...
func ExpandResourceKopsKubeProxyConfig(in map[string]interface{}) kops.KubeProxyConfig {
	if in == nil {
...
func FlattenResourceKopsKubeProxyConfigInto(in kops.KubeProxyConfig, out map[string]interface{}) {
...
func FlattenResourceKopsKubeProxyConfig(in kops.KubeProxyConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsKubeProxyConfigInto(in, out)
	return out
}
