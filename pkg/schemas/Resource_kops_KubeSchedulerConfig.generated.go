...
func ResourceKopsKubeSchedulerConfig() *schema.Resource {
...
func ExpandResourceKopsKubeSchedulerConfig(in map[string]interface{}) kops.KubeSchedulerConfig {
	if in == nil {
...
func FlattenResourceKopsKubeSchedulerConfigInto(in kops.KubeSchedulerConfig, out map[string]interface{}) {
...
func FlattenResourceKopsKubeSchedulerConfig(in kops.KubeSchedulerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsKubeSchedulerConfigInto(in, out)
	return out
}
