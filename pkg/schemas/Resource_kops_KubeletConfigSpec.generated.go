...
func ResourceKopsKubeletConfigSpec() *schema.Resource {
...
func ExpandResourceKopsKubeletConfigSpec(in map[string]interface{}) kops.KubeletConfigSpec {
	if in == nil {
...
func FlattenResourceKopsKubeletConfigSpecInto(in kops.KubeletConfigSpec, out map[string]interface{}) {
...
func FlattenResourceKopsKubeletConfigSpec(in kops.KubeletConfigSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsKubeletConfigSpecInto(in, out)
	return out
}
