...
func ResourceKopsLeaderElectionConfiguration() *schema.Resource {
...
func ExpandResourceKopsLeaderElectionConfiguration(in map[string]interface{}) kops.LeaderElectionConfiguration {
	if in == nil {
...
func FlattenResourceKopsLeaderElectionConfigurationInto(in kops.LeaderElectionConfiguration, out map[string]interface{}) {
...
func FlattenResourceKopsLeaderElectionConfiguration(in kops.LeaderElectionConfiguration) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsLeaderElectionConfigurationInto(in, out)
	return out
}
