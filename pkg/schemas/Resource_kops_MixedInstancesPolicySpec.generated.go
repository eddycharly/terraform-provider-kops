...
func ResourceKopsMixedInstancesPolicySpec() *schema.Resource {
...
func ExpandResourceKopsMixedInstancesPolicySpec(in map[string]interface{}) kops.MixedInstancesPolicySpec {
	if in == nil {
...
func FlattenResourceKopsMixedInstancesPolicySpecInto(in kops.MixedInstancesPolicySpec, out map[string]interface{}) {
...
func FlattenResourceKopsMixedInstancesPolicySpec(in kops.MixedInstancesPolicySpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsMixedInstancesPolicySpecInto(in, out)
	return out
}
