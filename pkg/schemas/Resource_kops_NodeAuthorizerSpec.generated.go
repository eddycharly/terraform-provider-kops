...
func ResourceKopsNodeAuthorizerSpec() *schema.Resource {
...
func ExpandResourceKopsNodeAuthorizerSpec(in map[string]interface{}) kops.NodeAuthorizerSpec {
	if in == nil {
...
func FlattenResourceKopsNodeAuthorizerSpecInto(in kops.NodeAuthorizerSpec, out map[string]interface{}) {
...
func FlattenResourceKopsNodeAuthorizerSpec(in kops.NodeAuthorizerSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsNodeAuthorizerSpecInto(in, out)
	return out
}
