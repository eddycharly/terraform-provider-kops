...
func ResourceKopsOpenstackConfiguration() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			"loadbalancer":         OptionalStruct(ResourceKopsOpenstackLoadbalancerConfig()),
			"monitor":              OptionalStruct(ResourceKopsOpenstackMonitor()),
			"router":               OptionalStruct(ResourceKopsOpenstackRouter()),
			"block_storage":        OptionalStruct(ResourceKopsOpenstackBlockStorageConfig()),
			"insecure_skip_verify": OptionalBool(),
		},
	}
}

func ExpandResourceKopsOpenstackConfiguration(in map[string]interface{}) kops.OpenstackConfiguration {
	if in == nil {
		...
		Loadbalancer: func(in interface{}) *kops.OpenstackLoadbalancerConfig {
			return func(in interface{}) *kops.OpenstackLoadbalancerConfig {
				...
				return func(in kops.OpenstackLoadbalancerConfig) *kops.OpenstackLoadbalancerConfig {
					...
					return (ExpandResourceKopsOpenstackLoadbalancerConfig(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["loadbalancer"]),
		Monitor: func(in interface{}) *kops.OpenstackMonitor {
			return func(in interface{}) *kops.OpenstackMonitor {
				...
				return func(in kops.OpenstackMonitor) *kops.OpenstackMonitor {
					...
					return (ExpandResourceKopsOpenstackMonitor(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["monitor"]),
		Router: func(in interface{}) *kops.OpenstackRouter {
			return func(in interface{}) *kops.OpenstackRouter {
				...
				return func(in kops.OpenstackRouter) *kops.OpenstackRouter {
					...
					return (ExpandResourceKopsOpenstackRouter(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["router"]),
		BlockStorage: func(in interface{}) *kops.OpenstackBlockStorageConfig {
			return func(in interface{}) *kops.OpenstackBlockStorageConfig {
				...
				return func(in kops.OpenstackBlockStorageConfig) *kops.OpenstackBlockStorageConfig {
					...
					return (ExpandResourceKopsOpenstackBlockStorageConfig(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["block_storage"]),
...
func FlattenResourceKopsOpenstackConfigurationInto(in kops.OpenstackConfiguration, out map[string]interface{}) {
		...
		return func(in *kops.OpenstackLoadbalancerConfig) interface{} {
			...
			return func(in kops.OpenstackLoadbalancerConfig) interface{} {
				return func(in kops.OpenstackLoadbalancerConfig) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsOpenstackLoadbalancerConfig(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Loadbalancer)
		...
		return func(in *kops.OpenstackMonitor) interface{} {
			...
			return func(in kops.OpenstackMonitor) interface{} {
				return func(in kops.OpenstackMonitor) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsOpenstackMonitor(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Monitor)
		...
		return func(in *kops.OpenstackRouter) interface{} {
			...
			return func(in kops.OpenstackRouter) interface{} {
				return func(in kops.OpenstackRouter) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsOpenstackRouter(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Router)
		...
		return func(in *kops.OpenstackBlockStorageConfig) interface{} {
			...
			return func(in kops.OpenstackBlockStorageConfig) interface{} {
				return func(in kops.OpenstackBlockStorageConfig) []map[string]interface{} {
					return []map[string]interface{}{FlattenResourceKopsOpenstackBlockStorageConfig(in)}
				}(in)
			}(*in)
		}(in)
	}(in.BlockStorage)
...
func FlattenResourceKopsOpenstackConfiguration(in kops.OpenstackConfiguration) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsOpenstackConfigurationInto(in, out)
	return out
}
