...
func ResourceKopsOpenstackLoadbalancerConfig() *schema.Resource {
...
func ExpandResourceKopsOpenstackLoadbalancerConfig(in map[string]interface{}) kops.OpenstackLoadbalancerConfig {
	if in == nil {
...
func FlattenResourceKopsOpenstackLoadbalancerConfigInto(in kops.OpenstackLoadbalancerConfig, out map[string]interface{}) {
...
func FlattenResourceKopsOpenstackLoadbalancerConfig(in kops.OpenstackLoadbalancerConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsOpenstackLoadbalancerConfigInto(in, out)
	return out
}
