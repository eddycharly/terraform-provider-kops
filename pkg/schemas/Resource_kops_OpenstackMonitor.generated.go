...
func ResourceKopsOpenstackMonitor() *schema.Resource {
...
func ExpandResourceKopsOpenstackMonitor(in map[string]interface{}) kops.OpenstackMonitor {
	if in == nil {
...
func FlattenResourceKopsOpenstackMonitorInto(in kops.OpenstackMonitor, out map[string]interface{}) {
...
func FlattenResourceKopsOpenstackMonitor(in kops.OpenstackMonitor) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsOpenstackMonitorInto(in, out)
	return out
}
