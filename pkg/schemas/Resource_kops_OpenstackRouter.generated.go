...
func ResourceKopsOpenstackRouter() *schema.Resource {
...
func ExpandResourceKopsOpenstackRouter(in map[string]interface{}) kops.OpenstackRouter {
	if in == nil {
...
func FlattenResourceKopsOpenstackRouterInto(in kops.OpenstackRouter, out map[string]interface{}) {
...
func FlattenResourceKopsOpenstackRouter(in kops.OpenstackRouter) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsOpenstackRouterInto(in, out)
	return out
}
