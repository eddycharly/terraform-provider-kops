...
func ResourceKopsVolumeMountSpec() *schema.Resource {
...
func ExpandResourceKopsVolumeMountSpec(in map[string]interface{}) kops.VolumeMountSpec {
	if in == nil {
...
func FlattenResourceKopsVolumeMountSpecInto(in kops.VolumeMountSpec, out map[string]interface{}) {
...
func FlattenResourceKopsVolumeMountSpec(in kops.VolumeMountSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsVolumeMountSpecInto(in, out)
	return out
}
