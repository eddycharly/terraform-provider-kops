...
func ResourceKopsVolumeSpec() *schema.Resource {
...
func ExpandResourceKopsVolumeSpec(in map[string]interface{}) kops.VolumeSpec {
	if in == nil {
...
func FlattenResourceKopsVolumeSpecInto(in kops.VolumeSpec, out map[string]interface{}) {
...
func FlattenResourceKopsVolumeSpec(in kops.VolumeSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsVolumeSpecInto(in, out)
	return out
}
