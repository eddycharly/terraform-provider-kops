...
func ResourceKopsWeaveNetworkingSpec() *schema.Resource {
...
func ExpandResourceKopsWeaveNetworkingSpec(in map[string]interface{}) kops.WeaveNetworkingSpec {
	if in == nil {
...
func FlattenResourceKopsWeaveNetworkingSpecInto(in kops.WeaveNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceKopsWeaveNetworkingSpec(in kops.WeaveNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKopsWeaveNetworkingSpecInto(in, out)
	return out
}
