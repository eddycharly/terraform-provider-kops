...
func ExpandResourceKubeConfig(in map[string]interface{}) kube.Config {
	if in == nil {
...
func FlattenResourceKubeConfigInto(in kube.Config, out map[string]interface{}) {
...
func FlattenResourceKubeConfig(in kube.Config) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceKubeConfigInto(in, out)
	return out
}
