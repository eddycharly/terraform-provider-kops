...
func TestExpandDataSourceCiliumNetworkingSpec(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := ExpandDataSourceCiliumNetworkingSpec(tt.args.in); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ExpandDataSourceCiliumNetworkingSpec() = %v, want %v", got, tt.want)
			}
		})
	}
}
