...
func TestExpandDataSourceKubeControllerManagerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := ExpandDataSourceKubeControllerManagerConfig(tt.args.in); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ExpandDataSourceKubeControllerManagerConfig() = %v, want %v", got, tt.want)
			}
		})
	}
}
