...
func TestFlattenDataSourceLeaderElectionConfigurationInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			FlattenDataSourceLeaderElectionConfigurationInto(tt.args.in, tt.args.out)
		})
	}
}
...
func TestFlattenDataSourceLeaderElectionConfiguration(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FlattenDataSourceLeaderElectionConfiguration(tt.args.in); !reflect.DeepEqual(got, tt.want) {
