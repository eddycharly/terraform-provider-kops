...
func TestFlattenDataSourceOpenstackBlockStorageConfigInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			FlattenDataSourceOpenstackBlockStorageConfigInto(tt.args.in, tt.args.out)
		})
	}
}
...
func TestFlattenDataSourceOpenstackBlockStorageConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FlattenDataSourceOpenstackBlockStorageConfig(tt.args.in); !reflect.DeepEqual(got, tt.want) {
