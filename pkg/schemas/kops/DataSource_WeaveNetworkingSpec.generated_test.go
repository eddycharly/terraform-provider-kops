...
func TestExpandDataSourceWeaveNetworkingSpec(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := ExpandDataSourceWeaveNetworkingSpec(tt.args.in); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ExpandDataSourceWeaveNetworkingSpec() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestFlattenDataSourceWeaveNetworkingSpecInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			FlattenDataSourceWeaveNetworkingSpecInto(tt.args.in, tt.args.out)
		})
	}
}
...
func TestFlattenDataSourceWeaveNetworkingSpec(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FlattenDataSourceWeaveNetworkingSpec(tt.args.in); !reflect.DeepEqual(got, tt.want) {
