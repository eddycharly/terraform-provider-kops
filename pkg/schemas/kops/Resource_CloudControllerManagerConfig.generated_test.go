...
func TestFlattenResourceCloudControllerManagerConfigInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			FlattenResourceCloudControllerManagerConfigInto(tt.args.in, tt.args.out)
		})
	}
}
...
func TestFlattenResourceCloudControllerManagerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FlattenResourceCloudControllerManagerConfig(tt.args.in); !reflect.DeepEqual(got, tt.want) {
