...
func ExpandResourceEgressProxySpec(in map[string]interface{}) kops.EgressProxySpec {
	...
	if in, ok := in["http_proxy"]; ok && in != nil {
		out.HTTPProxy = func(in interface{}) kops.HTTPProxy { return ExpandResourceHTTPProxy(in.(map[string]interface{})) }(in)
	}
...
func FlattenResourceEgressProxySpecInto(in kops.EgressProxySpec, out map[string]interface{}) {
	out["http_proxy"] = func(in kops.HTTPProxy) interface{} { return FlattenResourceHTTPProxy(in) }(in.HTTPProxy)
