...
func TestFlattenResourceKubeControllerManagerConfigInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			FlattenResourceKubeControllerManagerConfigInto(tt.args.in, tt.args.out)
		})
	}
}
...
func TestFlattenResourceKubeControllerManagerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FlattenResourceKubeControllerManagerConfig(tt.args.in); !reflect.DeepEqual(got, tt.want) {
