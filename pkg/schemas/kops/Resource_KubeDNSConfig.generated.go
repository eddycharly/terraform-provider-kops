...
func ResourceKubeDNSConfig() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"tolerations":          OptionalList(schemas.ResourceToleration()),
			"affinity":             OptionalStruct(schemas.ResourceAffinity()),
			...
			return func(in interface{}) []v1.Toleration {
				...
				for _, in := range in.([]interface{}) {
					out = append(out, func(in interface{}) v1.Toleration {
						...
						return (schemas.ExpandResourceToleration(in.(map[string]interface{})))
					}(in))
				}
				return out
			}(in)
		...
		Affinity: func(in interface{}) *v1.Affinity {
			return func(in interface{}) *v1.Affinity {
				...
				return func(in v1.Affinity) *v1.Affinity {
					...
					return (schemas.ExpandResourceAffinity(in.([]interface{})[0].(map[string]interface{})))
				}(in))
			}(in)
		}(in["affinity"]),
...
func FlattenResourceKubeDNSConfigInto(in kops.KubeDNSConfig, out map[string]interface{}) {
		...
		return func(in []v1.Toleration) []interface{} {
			...
			for _, in := range in {
				out = append(out, func(in v1.Toleration) interface{} {
					return schemas.FlattenResourceToleration(in)
				}(in))
			}
			return out
		}(in)
	...
	out["affinity"] = func(in *v1.Affinity) interface{} {
		return func(in *v1.Affinity) interface{} {
			...
			return func(in v1.Affinity) interface{} {
				return func(in v1.Affinity) []interface{} {
					return []interface{}{schemas.FlattenResourceAffinity(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Affinity)
