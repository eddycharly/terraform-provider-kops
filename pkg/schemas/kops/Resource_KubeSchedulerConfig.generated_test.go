...
func TestExpandResourceKubeSchedulerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := ExpandResourceKubeSchedulerConfig(tt.args.in); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("ExpandResourceKubeSchedulerConfig() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestFlattenResourceKubeSchedulerConfigInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			FlattenResourceKubeSchedulerConfigInto(tt.args.in, tt.args.out)
		})
	}
}
...
func TestFlattenResourceKubeSchedulerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FlattenResourceKubeSchedulerConfig(tt.args.in); !reflect.DeepEqual(got, tt.want) {
