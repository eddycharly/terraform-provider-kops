...
func TestFlattenResourceOpenstackLoadbalancerConfigInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			FlattenResourceOpenstackLoadbalancerConfigInto(tt.args.in, tt.args.out)
		})
	}
}
...
func TestFlattenResourceOpenstackLoadbalancerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := FlattenResourceOpenstackLoadbalancerConfig(tt.args.in); !reflect.DeepEqual(got, tt.want) {
