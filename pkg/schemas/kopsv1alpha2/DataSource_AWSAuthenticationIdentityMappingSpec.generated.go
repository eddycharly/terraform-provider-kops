...
func ExpandDataSourceAWSAuthenticationIdentityMappingSpec(in map[string]interface{}) kopsv1alpha2.AWSAuthenticationIdentityMappingSpec {
	if in == nil {
...
func FlattenDataSourceAWSAuthenticationIdentityMappingSpecInto(in kopsv1alpha2.AWSAuthenticationIdentityMappingSpec, out map[string]interface{}) {
...
func FlattenDataSourceAWSAuthenticationIdentityMappingSpec(in kopsv1alpha2.AWSAuthenticationIdentityMappingSpec) map[string]interface{} {
