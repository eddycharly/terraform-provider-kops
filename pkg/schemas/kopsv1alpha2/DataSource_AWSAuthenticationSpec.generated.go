...
func ExpandDataSourceAWSAuthenticationSpec(in map[string]interface{}) kopsv1alpha2.AWSAuthenticationSpec {
	if in == nil {
...
func FlattenDataSourceAWSAuthenticationSpecInto(in kopsv1alpha2.AWSAuthenticationSpec, out map[string]interface{}) {
...
func FlattenDataSourceAWSAuthenticationSpec(in kopsv1alpha2.AWSAuthenticationSpec) map[string]interface{} {
