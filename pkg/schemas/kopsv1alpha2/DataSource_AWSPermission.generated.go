...
func ExpandDataSourceAWSPermission(in map[string]interface{}) kopsv1alpha2.AWSPermission {
	if in == nil {
...
func FlattenDataSourceAWSPermissionInto(in kopsv1alpha2.AWSPermission, out map[string]interface{}) {
...
func FlattenDataSourceAWSPermission(in kopsv1alpha2.AWSPermission) map[string]interface{} {
