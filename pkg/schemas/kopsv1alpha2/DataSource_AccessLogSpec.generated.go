...
func ExpandDataSourceAccessLogSpec(in map[string]interface{}) kopsv1alpha2.AccessLogSpec {
	if in == nil {
...
func FlattenDataSourceAccessLogSpecInto(in kopsv1alpha2.AccessLogSpec, out map[string]interface{}) {
...
func FlattenDataSourceAccessLogSpec(in kopsv1alpha2.AccessLogSpec) map[string]interface{} {
