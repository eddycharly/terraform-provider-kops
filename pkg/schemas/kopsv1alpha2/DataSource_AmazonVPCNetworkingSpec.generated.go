...
func ExpandDataSourceAmazonVPCNetworkingSpec(in map[string]interface{}) kopsv1alpha2.AmazonVPCNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceAmazonVPCNetworkingSpecInto(in kopsv1alpha2.AmazonVPCNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceAmazonVPCNetworkingSpec(in kopsv1alpha2.AmazonVPCNetworkingSpec) map[string]interface{} {
