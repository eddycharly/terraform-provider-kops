...
func ExpandDataSourceAssets(in map[string]interface{}) kopsv1alpha2.Assets {
	if in == nil {
...
func FlattenDataSourceAssetsInto(in kopsv1alpha2.Assets, out map[string]interface{}) {
...
func FlattenDataSourceAssets(in kopsv1alpha2.Assets) map[string]interface{} {
