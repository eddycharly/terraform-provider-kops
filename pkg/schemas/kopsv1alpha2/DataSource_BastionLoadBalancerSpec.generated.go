...
func ExpandDataSourceBastionLoadBalancerSpec(in map[string]interface{}) kopsv1alpha2.BastionLoadBalancerSpec {
	if in == nil {
...
func FlattenDataSourceBastionLoadBalancerSpecInto(in kopsv1alpha2.BastionLoadBalancerSpec, out map[string]interface{}) {
...
func FlattenDataSourceBastionLoadBalancerSpec(in kopsv1alpha2.BastionLoadBalancerSpec) map[string]interface{} {
