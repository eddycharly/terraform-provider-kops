...
func ExpandDataSourceCalicoNetworkingSpec(in map[string]interface{}) kopsv1alpha2.CalicoNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceCalicoNetworkingSpecInto(in kopsv1alpha2.CalicoNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceCalicoNetworkingSpec(in kopsv1alpha2.CalicoNetworkingSpec) map[string]interface{} {
