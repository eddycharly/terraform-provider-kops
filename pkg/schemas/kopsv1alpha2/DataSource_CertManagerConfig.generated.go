...
func ExpandDataSourceCertManagerConfig(in map[string]interface{}) kopsv1alpha2.CertManagerConfig {
	if in == nil {
...
func FlattenDataSourceCertManagerConfigInto(in kopsv1alpha2.CertManagerConfig, out map[string]interface{}) {
...
func FlattenDataSourceCertManagerConfig(in kopsv1alpha2.CertManagerConfig) map[string]interface{} {
