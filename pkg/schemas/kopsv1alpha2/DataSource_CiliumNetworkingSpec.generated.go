...
func ExpandDataSourceCiliumNetworkingSpec(in map[string]interface{}) kopsv1alpha2.CiliumNetworkingSpec {
	if in == nil {
	...
	return kopsv1alpha2.CiliumNetworkingSpec{
		...
		EncryptionType: func(in interface{}) kopsv1alpha2.CiliumEncryptionType {
			return v1alpha2.CiliumEncryptionType(ExpandString(in))
		}(in["encryption_type"]),
		...
		Hubble: func(in interface{}) *kopsv1alpha2.HubbleSpec {
			return func(in interface{}) *kopsv1alpha2.HubbleSpec {
				if in == nil {
					return nil
				}
				if _, ok := in.([]interface{}); ok && len(in.([]interface{})) == 0 {
				...
				return func(in kopsv1alpha2.HubbleSpec) *kopsv1alpha2.HubbleSpec {
					return &in
				}(func(in interface{}) kopsv1alpha2.HubbleSpec {
...
func FlattenDataSourceCiliumNetworkingSpecInto(in kopsv1alpha2.CiliumNetworkingSpec, out map[string]interface{}) {
	...
	out["encryption_type"] = func(in kopsv1alpha2.CiliumEncryptionType) interface{} {
		return FlattenString(string(in))
	}(in.EncryptionType)
	...
	out["hubble"] = func(in *kopsv1alpha2.HubbleSpec) interface{} {
		return func(in *kopsv1alpha2.HubbleSpec) interface{} {
			if in == nil {
				return nil
			}
			return func(in kopsv1alpha2.HubbleSpec) interface{} {
...
func FlattenDataSourceCiliumNetworkingSpec(in kopsv1alpha2.CiliumNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
