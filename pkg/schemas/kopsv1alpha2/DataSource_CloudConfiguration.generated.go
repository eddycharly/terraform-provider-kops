...
func DataSourceCloudConfiguration() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"aws_ebs_csi_driver":             ComputedStruct(DataSourceEBSCSIDriverSpec()),
			"gcp_pd_csi_driver":              ComputedStruct(DataSourcePDCSIDriver()),
		},
	}
...
func ExpandDataSourceCloudConfiguration(in map[string]interface{}) kopsv1alpha2.CloudConfiguration {
	if in == nil {
...
func FlattenDataSourceCloudConfigurationInto(in kopsv1alpha2.CloudConfiguration, out map[string]interface{}) {
...
func FlattenDataSourceCloudConfiguration(in kopsv1alpha2.CloudConfiguration) map[string]interface{} {
