...
func ExpandDataSourceCloudControllerManagerConfig(in map[string]interface{}) kopsv1alpha2.CloudControllerManagerConfig {
	if in == nil {
...
func FlattenDataSourceCloudControllerManagerConfigInto(in kopsv1alpha2.CloudControllerManagerConfig, out map[string]interface{}) {
...
func FlattenDataSourceCloudControllerManagerConfig(in kopsv1alpha2.CloudControllerManagerConfig) map[string]interface{} {
