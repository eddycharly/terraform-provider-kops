...
func ExpandDataSourceClusterAutoscalerConfig(in map[string]interface{}) kopsv1alpha2.ClusterAutoscalerConfig {
	if in == nil {
...
func FlattenDataSourceClusterAutoscalerConfigInto(in kopsv1alpha2.ClusterAutoscalerConfig, out map[string]interface{}) {
...
func FlattenDataSourceClusterAutoscalerConfig(in kopsv1alpha2.ClusterAutoscalerConfig) map[string]interface{} {
	out := map[string]interface{}{}
