...
func DataSourceClusterSpec() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"aws_load_balancer_controller":      ComputedStruct(DataSourceLoadBalancerControllerSpec()),
			"legacy_networking":                 ComputedStruct(DataSourceNetworkingSpec()),
			"networking":                        ComputedStruct(DataSourceNetworkingSpec()),
			"legacy_api":                        ComputedStruct(DataSourceAPISpec()),
...
func ExpandDataSourceClusterSpec(in map[string]interface{}) kopsv1alpha2.ClusterSpec {
	if in == nil {
...
func FlattenDataSourceClusterSpecInto(in kopsv1alpha2.ClusterSpec, out map[string]interface{}) {
...
func FlattenDataSourceClusterSpec(in kopsv1alpha2.ClusterSpec) map[string]interface{} {
	out := map[string]interface{}{}
