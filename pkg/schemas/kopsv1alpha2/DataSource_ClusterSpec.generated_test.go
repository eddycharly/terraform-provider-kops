			...
			args: args{
				in: map[string]interface{}{
					...
					"networking": func() []interface{} {
						return []interface{}{FlattenDataSourceNetworkingSpec(kopsv1alpha2.NetworkingSpec{})}
					}(),
					"legacy_api":                       nil,
					"api":                              func() []interface{} { return []interface{}{FlattenDataSourceAPISpec(kopsv1alpha2.APISpec{})} }(),
					"authentication":                   nil,
					"authorization":                    nil,
