...
func ExpandDataSourceDNSControllerGossipConfigSecondary(in map[string]interface{}) kopsv1alpha2.DNSControllerGossipConfigSecondary {
	if in == nil {
...
func FlattenDataSourceDNSControllerGossipConfigSecondaryInto(in kopsv1alpha2.DNSControllerGossipConfigSecondary, out map[string]interface{}) {
...
func FlattenDataSourceDNSControllerGossipConfigSecondary(in kopsv1alpha2.DNSControllerGossipConfigSecondary) map[string]interface{} {
