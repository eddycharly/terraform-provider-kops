...
func ExpandDataSourceDockerConfig(in map[string]interface{}) kopsv1alpha2.DockerConfig {
	if in == nil {
...
func FlattenDataSourceDockerConfigInto(in kopsv1alpha2.DockerConfig, out map[string]interface{}) {
...
func FlattenDataSourceDockerConfig(in kopsv1alpha2.DockerConfig) map[string]interface{} {
