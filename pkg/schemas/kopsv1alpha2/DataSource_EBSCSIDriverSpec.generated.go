...
func ExpandDataSourceEBSCSIDriverSpec(in map[string]interface{}) kopsv1alpha2.EBSCSIDriverSpec {
	if in == nil {
...
func FlattenDataSourceEBSCSIDriverSpecInto(in kopsv1alpha2.EBSCSIDriverSpec, out map[string]interface{}) {
...
func FlattenDataSourceEBSCSIDriverSpec(in kopsv1alpha2.EBSCSIDriverSpec) map[string]interface{} {
	out := map[string]interface{}{}
