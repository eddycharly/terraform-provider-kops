...
func ExpandDataSourceEtcdManagerSpec(in map[string]interface{}) kopsv1alpha2.EtcdManagerSpec {
	if in == nil {
...
func FlattenDataSourceEtcdManagerSpecInto(in kopsv1alpha2.EtcdManagerSpec, out map[string]interface{}) {
...
func FlattenDataSourceEtcdManagerSpec(in kopsv1alpha2.EtcdManagerSpec) map[string]interface{} {
