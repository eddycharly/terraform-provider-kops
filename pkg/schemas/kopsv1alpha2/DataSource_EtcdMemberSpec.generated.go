...
func ExpandDataSourceEtcdMemberSpec(in map[string]interface{}) kopsv1alpha2.EtcdMemberSpec {
	if in == nil {
...
func FlattenDataSourceEtcdMemberSpecInto(in kopsv1alpha2.EtcdMemberSpec, out map[string]interface{}) {
...
func FlattenDataSourceEtcdMemberSpec(in kopsv1alpha2.EtcdMemberSpec) map[string]interface{} {
