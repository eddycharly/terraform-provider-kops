...
func ExpandDataSourceFileAssetSpec(in map[string]interface{}) kopsv1alpha2.FileAssetSpec {
	if in == nil {
...
func FlattenDataSourceFileAssetSpecInto(in kopsv1alpha2.FileAssetSpec, out map[string]interface{}) {
...
func FlattenDataSourceFileAssetSpec(in kopsv1alpha2.FileAssetSpec) map[string]interface{} {
