...
func ExpandDataSourceFlannelNetworkingSpec(in map[string]interface{}) kopsv1alpha2.FlannelNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceFlannelNetworkingSpecInto(in kopsv1alpha2.FlannelNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceFlannelNetworkingSpec(in kopsv1alpha2.FlannelNetworkingSpec) map[string]interface{} {
