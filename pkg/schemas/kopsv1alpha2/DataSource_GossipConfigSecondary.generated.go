...
func ExpandDataSourceGossipConfigSecondary(in map[string]interface{}) kopsv1alpha2.GossipConfigSecondary {
	if in == nil {
...
func FlattenDataSourceGossipConfigSecondaryInto(in kopsv1alpha2.GossipConfigSecondary, out map[string]interface{}) {
...
func FlattenDataSourceGossipConfigSecondary(in kopsv1alpha2.GossipConfigSecondary) map[string]interface{} {
