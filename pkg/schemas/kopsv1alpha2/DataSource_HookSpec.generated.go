...
func ExpandDataSourceHookSpec(in map[string]interface{}) kopsv1alpha2.HookSpec {
	if in == nil {
...
func FlattenDataSourceHookSpecInto(in kopsv1alpha2.HookSpec, out map[string]interface{}) {
...
func FlattenDataSourceHookSpec(in kopsv1alpha2.HookSpec) map[string]interface{} {
