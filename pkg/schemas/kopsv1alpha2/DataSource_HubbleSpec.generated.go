...
func ExpandDataSourceHubbleSpec(in map[string]interface{}) kopsv1alpha2.HubbleSpec {
	if in == nil {
...
func FlattenDataSourceHubbleSpecInto(in kopsv1alpha2.HubbleSpec, out map[string]interface{}) {
...
func FlattenDataSourceHubbleSpec(in kopsv1alpha2.HubbleSpec) map[string]interface{} {
