...
func ExpandDataSourceInstanceMetadataOptions(in map[string]interface{}) kopsv1alpha2.InstanceMetadataOptions {
	if in == nil {
...
func FlattenDataSourceInstanceMetadataOptionsInto(in kopsv1alpha2.InstanceMetadataOptions, out map[string]interface{}) {
...
func FlattenDataSourceInstanceMetadataOptions(in kopsv1alpha2.InstanceMetadataOptions) map[string]interface{} {
