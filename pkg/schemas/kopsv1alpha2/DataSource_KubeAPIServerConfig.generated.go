...
func ExpandDataSourceKubeAPIServerConfig(in map[string]interface{}) kopsv1alpha2.KubeAPIServerConfig {
	if in == nil {
...
func FlattenDataSourceKubeAPIServerConfigInto(in kopsv1alpha2.KubeAPIServerConfig, out map[string]interface{}) {
...
func FlattenDataSourceKubeAPIServerConfig(in kopsv1alpha2.KubeAPIServerConfig) map[string]interface{} {
	out := map[string]interface{}{}
