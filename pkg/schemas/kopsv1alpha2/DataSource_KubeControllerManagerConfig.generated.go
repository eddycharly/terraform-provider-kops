...
func ExpandDataSourceKubeControllerManagerConfig(in map[string]interface{}) kopsv1alpha2.KubeControllerManagerConfig {
	if in == nil {
...
func FlattenDataSourceKubeControllerManagerConfigInto(in kopsv1alpha2.KubeControllerManagerConfig, out map[string]interface{}) {
...
func FlattenDataSourceKubeControllerManagerConfig(in kopsv1alpha2.KubeControllerManagerConfig) map[string]interface{} {
	out := map[string]interface{}{}
