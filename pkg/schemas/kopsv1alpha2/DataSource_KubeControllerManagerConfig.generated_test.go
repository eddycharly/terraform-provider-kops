...
func TestExpandDataSourceKubeControllerManagerConfig(t *testing.T) {
	_default := kopsv1alpha2.KubeControllerManagerConfig{}
	type args struct {
	...
	tests := []struct {
		name string
		args args
		want kopsv1alpha2.KubeControllerManagerConfig
	}{
		{
			name: "default",
			args: args{
...
func TestFlattenDataSourceKubeControllerManagerConfigInto(t *testing.T) {
	...
	type args struct {
		in kopsv1alpha2.KubeControllerManagerConfig
	}
	tests := []struct {
		name string
		args args
		...
		},
		{
			name: "Master - default",
			args: args{
				in: func() kopsv1alpha2.KubeControllerManagerConfig {
					subject := kopsv1alpha2.KubeControllerManagerConfig{}
					subject.Master = ""
					return subject
				}(),
			},
