...
func ExpandDataSourceKubeProxyConfig(in map[string]interface{}) kopsv1alpha2.KubeProxyConfig {
	if in == nil {
...
func FlattenDataSourceKubeProxyConfigInto(in kopsv1alpha2.KubeProxyConfig, out map[string]interface{}) {
...
func FlattenDataSourceKubeProxyConfig(in kopsv1alpha2.KubeProxyConfig) map[string]interface{} {
	out := map[string]interface{}{}
