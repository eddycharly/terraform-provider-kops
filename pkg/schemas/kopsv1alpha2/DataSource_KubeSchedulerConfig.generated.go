...
func ExpandDataSourceKubeSchedulerConfig(in map[string]interface{}) kopsv1alpha2.KubeSchedulerConfig {
	if in == nil {
...
func FlattenDataSourceKubeSchedulerConfigInto(in kopsv1alpha2.KubeSchedulerConfig, out map[string]interface{}) {
...
func FlattenDataSourceKubeSchedulerConfig(in kopsv1alpha2.KubeSchedulerConfig) map[string]interface{} {
	out := map[string]interface{}{}
