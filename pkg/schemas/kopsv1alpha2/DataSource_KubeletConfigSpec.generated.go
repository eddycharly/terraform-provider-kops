...
func ExpandDataSourceKubeletConfigSpec(in map[string]interface{}) kopsv1alpha2.KubeletConfigSpec {
	if in == nil {
...
func FlattenDataSourceKubeletConfigSpecInto(in kopsv1alpha2.KubeletConfigSpec, out map[string]interface{}) {
...
func FlattenDataSourceKubeletConfigSpec(in kopsv1alpha2.KubeletConfigSpec) map[string]interface{} {
	out := map[string]interface{}{}
