...
func ExpandDataSourceLeaderElectionConfiguration(in map[string]interface{}) kopsv1alpha2.LeaderElectionConfiguration {
	if in == nil {
...
func FlattenDataSourceLeaderElectionConfigurationInto(in kopsv1alpha2.LeaderElectionConfiguration, out map[string]interface{}) {
...
func FlattenDataSourceLeaderElectionConfiguration(in kopsv1alpha2.LeaderElectionConfiguration) map[string]interface{} {
