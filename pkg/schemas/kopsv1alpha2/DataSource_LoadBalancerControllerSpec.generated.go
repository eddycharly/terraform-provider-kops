...
func ExpandDataSourceLoadBalancerControllerSpec(in map[string]interface{}) kopsv1alpha2.LoadBalancerControllerSpec {
	if in == nil {
...
func FlattenDataSourceLoadBalancerControllerSpecInto(in kopsv1alpha2.LoadBalancerControllerSpec, out map[string]interface{}) {
...
func FlattenDataSourceLoadBalancerControllerSpec(in kopsv1alpha2.LoadBalancerControllerSpec) map[string]interface{} {
