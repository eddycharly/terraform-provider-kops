...
func ExpandDataSourceLoadBalancerSpec(in map[string]interface{}) kopsv1alpha2.LoadBalancerSpec {
	if in == nil {
...
func FlattenDataSourceLoadBalancerSpecInto(in kopsv1alpha2.LoadBalancerSpec, out map[string]interface{}) {
...
func FlattenDataSourceLoadBalancerSpec(in kopsv1alpha2.LoadBalancerSpec) map[string]interface{} {
