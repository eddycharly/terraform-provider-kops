...
func ExpandDataSourceLoadBalancerSubnetSpec(in map[string]interface{}) kopsv1alpha2.LoadBalancerSubnetSpec {
	if in == nil {
...
func FlattenDataSourceLoadBalancerSubnetSpecInto(in kopsv1alpha2.LoadBalancerSubnetSpec, out map[string]interface{}) {
...
func FlattenDataSourceLoadBalancerSubnetSpec(in kopsv1alpha2.LoadBalancerSubnetSpec) map[string]interface{} {
