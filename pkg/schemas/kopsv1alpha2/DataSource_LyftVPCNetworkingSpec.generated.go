...
func ExpandDataSourceLyftVPCNetworkingSpec(in map[string]interface{}) kopsv1alpha2.LyftVPCNetworkingSpec {
	if in == nil {
...
func FlattenDataSourceLyftVPCNetworkingSpecInto(in kopsv1alpha2.LyftVPCNetworkingSpec, out map[string]interface{}) {
...
func FlattenDataSourceLyftVPCNetworkingSpec(in kopsv1alpha2.LyftVPCNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
