...
func ExpandDataSourceNodeAuthorizerSpec(in map[string]interface{}) kopsv1alpha2.NodeAuthorizerSpec {
	if in == nil {
...
func FlattenDataSourceNodeAuthorizerSpecInto(in kopsv1alpha2.NodeAuthorizerSpec, out map[string]interface{}) {
...
func FlattenDataSourceNodeAuthorizerSpec(in kopsv1alpha2.NodeAuthorizerSpec) map[string]interface{} {
