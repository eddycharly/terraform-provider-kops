...
func ExpandDataSourceNodeLocalDNSConfig(in map[string]interface{}) kopsv1alpha2.NodeLocalDNSConfig {
	if in == nil {
...
func FlattenDataSourceNodeLocalDNSConfigInto(in kopsv1alpha2.NodeLocalDNSConfig, out map[string]interface{}) {
...
func FlattenDataSourceNodeLocalDNSConfig(in kopsv1alpha2.NodeLocalDNSConfig) map[string]interface{} {
	out := map[string]interface{}{}
