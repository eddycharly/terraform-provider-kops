...
func ExpandDataSourceNodeProblemDetectorConfig(in map[string]interface{}) kopsv1alpha2.NodeProblemDetectorConfig {
	if in == nil {
...
func FlattenDataSourceNodeProblemDetectorConfigInto(in kopsv1alpha2.NodeProblemDetectorConfig, out map[string]interface{}) {
...
func FlattenDataSourceNodeProblemDetectorConfig(in kopsv1alpha2.NodeProblemDetectorConfig) map[string]interface{} {
