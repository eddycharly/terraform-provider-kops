...
func ExpandDataSourceNodeTerminationHandlerSpec(in map[string]interface{}) kopsv1alpha2.NodeTerminationHandlerSpec {
	if in == nil {
...
func FlattenDataSourceNodeTerminationHandlerSpecInto(in kopsv1alpha2.NodeTerminationHandlerSpec, out map[string]interface{}) {
...
func FlattenDataSourceNodeTerminationHandlerSpec(in kopsv1alpha2.NodeTerminationHandlerSpec) map[string]interface{} {
