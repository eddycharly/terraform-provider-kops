...
func ExpandDataSourceOpenstackLoadbalancerConfig(in map[string]interface{}) kopsv1alpha2.OpenstackLoadbalancerConfig {
	if in == nil {
...
func FlattenDataSourceOpenstackLoadbalancerConfigInto(in kopsv1alpha2.OpenstackLoadbalancerConfig, out map[string]interface{}) {
...
func FlattenDataSourceOpenstackLoadbalancerConfig(in kopsv1alpha2.OpenstackLoadbalancerConfig) map[string]interface{} {
