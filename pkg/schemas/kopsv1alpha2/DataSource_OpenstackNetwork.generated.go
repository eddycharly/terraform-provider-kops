...
func ExpandDataSourceOpenstackNetwork(in map[string]interface{}) kopsv1alpha2.OpenstackNetwork {
	if in == nil {
...
func FlattenDataSourceOpenstackNetworkInto(in kopsv1alpha2.OpenstackNetwork, out map[string]interface{}) {
...
func FlattenDataSourceOpenstackNetwork(in kopsv1alpha2.OpenstackNetwork) map[string]interface{} {
