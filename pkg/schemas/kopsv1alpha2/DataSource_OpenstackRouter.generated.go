...
func ExpandDataSourceOpenstackRouter(in map[string]interface{}) kopsv1alpha2.OpenstackRouter {
	if in == nil {
...
func FlattenDataSourceOpenstackRouterInto(in kopsv1alpha2.OpenstackRouter, out map[string]interface{}) {
...
func FlattenDataSourceOpenstackRouter(in kopsv1alpha2.OpenstackRouter) map[string]interface{} {
