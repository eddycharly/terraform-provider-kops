...
func ExpandDataSourcePackagesConfig(in map[string]interface{}) kopsv1alpha2.PackagesConfig {
	if in == nil {
...
func FlattenDataSourcePackagesConfigInto(in kopsv1alpha2.PackagesConfig, out map[string]interface{}) {
...
func FlattenDataSourcePackagesConfig(in kopsv1alpha2.PackagesConfig) map[string]interface{} {
