...
func ExpandDataSourceRollingUpdate(in map[string]interface{}) kopsv1alpha2.RollingUpdate {
	if in == nil {
...
func FlattenDataSourceRollingUpdateInto(in kopsv1alpha2.RollingUpdate, out map[string]interface{}) {
...
func FlattenDataSourceRollingUpdate(in kopsv1alpha2.RollingUpdate) map[string]interface{} {
