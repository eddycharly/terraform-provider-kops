...
func TestExpandDataSourceServiceAccountIssuerDiscoveryConfig(t *testing.T) {
	_default := kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig{}
	type args struct {
	...
	tests := []struct {
		name string
		args args
		want kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig
	}{
		{
			name: "default",
			args: args{
...
func TestFlattenDataSourceServiceAccountIssuerDiscoveryConfigInto(t *testing.T) {
	...
	type args struct {
		in kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig
	}
	tests := []struct {
		name string
		args args
		...
		},
		{
			...
			args: args{
				in: func() kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig {
					subject := kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig{}
