...
func ExpandDataSourceUserData(in map[string]interface{}) kopsv1alpha2.UserData {
	if in == nil {
...
func FlattenDataSourceUserDataInto(in kopsv1alpha2.UserData, out map[string]interface{}) {
...
func FlattenDataSourceUserData(in kopsv1alpha2.UserData) map[string]interface{} {
