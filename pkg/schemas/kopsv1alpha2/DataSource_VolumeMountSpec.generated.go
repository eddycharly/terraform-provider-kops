...
func ExpandDataSourceVolumeMountSpec(in map[string]interface{}) kopsv1alpha2.VolumeMountSpec {
	if in == nil {
...
func FlattenDataSourceVolumeMountSpecInto(in kopsv1alpha2.VolumeMountSpec, out map[string]interface{}) {
...
func FlattenDataSourceVolumeMountSpec(in kopsv1alpha2.VolumeMountSpec) map[string]interface{} {
