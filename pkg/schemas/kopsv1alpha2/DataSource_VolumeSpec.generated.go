...
func ExpandDataSourceVolumeSpec(in map[string]interface{}) kopsv1alpha2.VolumeSpec {
	if in == nil {
...
func FlattenDataSourceVolumeSpecInto(in kopsv1alpha2.VolumeSpec, out map[string]interface{}) {
...
func FlattenDataSourceVolumeSpec(in kopsv1alpha2.VolumeSpec) map[string]interface{} {
