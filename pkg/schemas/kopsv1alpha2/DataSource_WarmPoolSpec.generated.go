...
func ExpandDataSourceWarmPoolSpec(in map[string]interface{}) kopsv1alpha2.WarmPoolSpec {
	if in == nil {
...
func FlattenDataSourceWarmPoolSpecInto(in kopsv1alpha2.WarmPoolSpec, out map[string]interface{}) {
...
func FlattenDataSourceWarmPoolSpec(in kopsv1alpha2.WarmPoolSpec) map[string]interface{} {
