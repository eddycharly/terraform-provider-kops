...
func ExpandResourceAPISpec(in map[string]interface{}) kopsv1alpha2.APISpec {
	if in == nil {
...
func FlattenResourceAPISpecInto(in kopsv1alpha2.APISpec, out map[string]interface{}) {
...
func FlattenResourceAPISpec(in kopsv1alpha2.APISpec) map[string]interface{} {
