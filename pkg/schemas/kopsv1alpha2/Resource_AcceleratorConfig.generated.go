...
func ExpandResourceAcceleratorConfig(in map[string]interface{}) kopsv1alpha2.AcceleratorConfig {
	if in == nil {
...
func FlattenResourceAcceleratorConfigInto(in kopsv1alpha2.AcceleratorConfig, out map[string]interface{}) {
...
func FlattenResourceAcceleratorConfig(in kopsv1alpha2.AcceleratorConfig) map[string]interface{} {
