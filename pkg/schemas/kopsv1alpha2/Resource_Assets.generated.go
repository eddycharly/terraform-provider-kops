...
func ExpandResourceAssets(in map[string]interface{}) kopsv1alpha2.Assets {
	if in == nil {
...
func FlattenResourceAssetsInto(in kopsv1alpha2.Assets, out map[string]interface{}) {
...
func FlattenResourceAssets(in kopsv1alpha2.Assets) map[string]interface{} {
