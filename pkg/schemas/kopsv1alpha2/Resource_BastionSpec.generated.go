...
func ExpandResourceBastionSpec(in map[string]interface{}) kopsv1alpha2.BastionSpec {
	if in == nil {
...
func FlattenResourceBastionSpecInto(in kopsv1alpha2.BastionSpec, out map[string]interface{}) {
...
func FlattenResourceBastionSpec(in kopsv1alpha2.BastionSpec) map[string]interface{} {
