...
func ExpandResourceCNINetworkingSpec(in map[string]interface{}) kopsv1alpha2.CNINetworkingSpec {
	if in == nil {
...
func FlattenResourceCNINetworkingSpecInto(in kopsv1alpha2.CNINetworkingSpec, out map[string]interface{}) {
	out["uses_secondary_ip"] = func(in bool) interface{} {
		return FlattenBool(bool(in))
	}(in.UsesSecondaryIP)
}

func FlattenResourceCNINetworkingSpec(in kopsv1alpha2.CNINetworkingSpec) map[string]interface{} {
