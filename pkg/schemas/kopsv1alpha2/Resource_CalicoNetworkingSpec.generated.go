...
func ExpandResourceCalicoNetworkingSpec(in map[string]interface{}) kopsv1alpha2.CalicoNetworkingSpec {
	if in == nil {
...
func FlattenResourceCalicoNetworkingSpecInto(in kopsv1alpha2.CalicoNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceCalicoNetworkingSpec(in kopsv1alpha2.CalicoNetworkingSpec) map[string]interface{} {
