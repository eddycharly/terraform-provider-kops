...
func ExpandResourceCanalNetworkingSpec(in map[string]interface{}) kopsv1alpha2.CanalNetworkingSpec {
	if in == nil {
...
func FlattenResourceCanalNetworkingSpecInto(in kopsv1alpha2.CanalNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceCanalNetworkingSpec(in kopsv1alpha2.CanalNetworkingSpec) map[string]interface{} {
