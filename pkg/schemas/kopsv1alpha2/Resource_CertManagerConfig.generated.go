...
func ExpandResourceCertManagerConfig(in map[string]interface{}) kopsv1alpha2.CertManagerConfig {
	if in == nil {
...
func FlattenResourceCertManagerConfigInto(in kopsv1alpha2.CertManagerConfig, out map[string]interface{}) {
...
func FlattenResourceCertManagerConfig(in kopsv1alpha2.CertManagerConfig) map[string]interface{} {
