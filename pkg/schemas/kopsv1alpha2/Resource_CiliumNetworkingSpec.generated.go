...
func ExpandResourceCiliumNetworkingSpec(in map[string]interface{}) kopsv1alpha2.CiliumNetworkingSpec {
	if in == nil {
...
func FlattenResourceCiliumNetworkingSpecInto(in kopsv1alpha2.CiliumNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceCiliumNetworkingSpec(in kopsv1alpha2.CiliumNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
