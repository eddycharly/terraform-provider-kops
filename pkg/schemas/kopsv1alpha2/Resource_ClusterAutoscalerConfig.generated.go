...
func ExpandResourceClusterAutoscalerConfig(in map[string]interface{}) kopsv1alpha2.ClusterAutoscalerConfig {
	if in == nil {
...
func FlattenResourceClusterAutoscalerConfigInto(in kopsv1alpha2.ClusterAutoscalerConfig, out map[string]interface{}) {
...
func FlattenResourceClusterAutoscalerConfig(in kopsv1alpha2.ClusterAutoscalerConfig) map[string]interface{} {
	out := map[string]interface{}{}
