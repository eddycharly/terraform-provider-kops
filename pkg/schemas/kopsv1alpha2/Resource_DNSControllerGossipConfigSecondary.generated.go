...
func ExpandResourceDNSControllerGossipConfigSecondary(in map[string]interface{}) kopsv1alpha2.DNSControllerGossipConfigSecondary {
	if in == nil {
...
func FlattenResourceDNSControllerGossipConfigSecondaryInto(in kopsv1alpha2.DNSControllerGossipConfigSecondary, out map[string]interface{}) {
...
func FlattenResourceDNSControllerGossipConfigSecondary(in kopsv1alpha2.DNSControllerGossipConfigSecondary) map[string]interface{} {
