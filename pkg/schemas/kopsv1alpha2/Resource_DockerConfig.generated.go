...
func ExpandResourceDockerConfig(in map[string]interface{}) kopsv1alpha2.DockerConfig {
	if in == nil {
...
func FlattenResourceDockerConfigInto(in kopsv1alpha2.DockerConfig, out map[string]interface{}) {
...
func FlattenResourceDockerConfig(in kopsv1alpha2.DockerConfig) map[string]interface{} {
