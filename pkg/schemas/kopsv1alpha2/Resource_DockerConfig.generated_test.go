...
func TestExpandResourceDockerConfig(t *testing.T) {
	_default := kopsv1alpha2.DockerConfig{}
	type args struct {
	...
	tests := []struct {
		name string
		args args
		want kopsv1alpha2.DockerConfig
	}{
		{
			name: "default",
			args: args{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := ExpandResourceDockerConfig(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("ExpandResourceDockerConfig() mismatch (-want +got):\n%s", diff)
			}
		})
	}
}
...
func TestFlattenResourceDockerConfigInto(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				in: func() kopsv1alpha2.DockerConfig {
					subject := kopsv1alpha2.DockerConfig{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			FlattenResourceDockerConfigInto(tt.args.in, got)
			if diff := cmp.Diff(tt.want, got); diff != "" {
...
func TestFlattenResourceDockerConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := FlattenResourceDockerConfig(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("FlattenResourceDockerConfig() mismatch (-want +got):\n%s", diff)
			}
		})
