...
func ExpandResourceEBSCSIDriverSpec(in map[string]interface{}) kopsv1alpha2.EBSCSIDriverSpec {
	if in == nil {
...
func FlattenResourceEBSCSIDriverSpecInto(in kopsv1alpha2.EBSCSIDriverSpec, out map[string]interface{}) {
...
func FlattenResourceEBSCSIDriverSpec(in kopsv1alpha2.EBSCSIDriverSpec) map[string]interface{} {
	out := map[string]interface{}{}
