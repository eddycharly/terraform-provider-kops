...
func ExpandResourceEtcdMemberSpec(in map[string]interface{}) kopsv1alpha2.EtcdMemberSpec {
	if in == nil {
...
func FlattenResourceEtcdMemberSpecInto(in kopsv1alpha2.EtcdMemberSpec, out map[string]interface{}) {
...
func FlattenResourceEtcdMemberSpec(in kopsv1alpha2.EtcdMemberSpec) map[string]interface{} {
