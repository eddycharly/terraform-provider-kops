...
func ExpandResourceExecContainerAction(in map[string]interface{}) kopsv1alpha2.ExecContainerAction {
	if in == nil {
...
func FlattenResourceExecContainerActionInto(in kopsv1alpha2.ExecContainerAction, out map[string]interface{}) {
...
func FlattenResourceExecContainerAction(in kopsv1alpha2.ExecContainerAction) map[string]interface{} {
	out := map[string]interface{}{}
