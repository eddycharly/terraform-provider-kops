...
func ExpandResourceHTTPProxy(in map[string]interface{}) kopsv1alpha2.HTTPProxy {
	if in == nil {
...
func FlattenResourceHTTPProxyInto(in kopsv1alpha2.HTTPProxy, out map[string]interface{}) {
...
func FlattenResourceHTTPProxy(in kopsv1alpha2.HTTPProxy) map[string]interface{} {
