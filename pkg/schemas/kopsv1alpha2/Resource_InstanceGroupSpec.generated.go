...
func ExpandResourceInstanceGroupSpec(in map[string]interface{}) kopsv1alpha2.InstanceGroupSpec {
	if in == nil {
...
func FlattenResourceInstanceGroupSpecInto(in kopsv1alpha2.InstanceGroupSpec, out map[string]interface{}) {
...
func FlattenResourceInstanceGroupSpec(in kopsv1alpha2.InstanceGroupSpec) map[string]interface{} {
	out := map[string]interface{}{}
