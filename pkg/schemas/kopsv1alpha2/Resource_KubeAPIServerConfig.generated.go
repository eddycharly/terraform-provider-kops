...
func ExpandResourceKubeAPIServerConfig(in map[string]interface{}) kopsv1alpha2.KubeAPIServerConfig {
	if in == nil {
...
func FlattenResourceKubeAPIServerConfigInto(in kopsv1alpha2.KubeAPIServerConfig, out map[string]interface{}) {
...
func FlattenResourceKubeAPIServerConfig(in kopsv1alpha2.KubeAPIServerConfig) map[string]interface{} {
	out := map[string]interface{}{}
