...
func TestExpandResourceKubeAPIServerConfig(t *testing.T) {
	_default := kopsv1alpha2.KubeAPIServerConfig{}
	type args struct {
	...
	tests := []struct {
		name string
		args args
		want kopsv1alpha2.KubeAPIServerConfig
	}{
		{
			name: "default",
			args: args{
...
func TestFlattenResourceKubeAPIServerConfigInto(t *testing.T) {
	...
	type args struct {
		in kopsv1alpha2.KubeAPIServerConfig
	}
	tests := []struct {
		name string
		args args
		...
		},
		{
			name: "Image - default",
			args: args{
				in: func() kopsv1alpha2.KubeAPIServerConfig {
					subject := kopsv1alpha2.KubeAPIServerConfig{}
					subject.Image = ""
					return subject
				}(),
			},
