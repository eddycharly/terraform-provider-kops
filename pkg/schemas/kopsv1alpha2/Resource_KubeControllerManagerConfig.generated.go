...
func ExpandResourceKubeControllerManagerConfig(in map[string]interface{}) kopsv1alpha2.KubeControllerManagerConfig {
	if in == nil {
...
func FlattenResourceKubeControllerManagerConfigInto(in kopsv1alpha2.KubeControllerManagerConfig, out map[string]interface{}) {
...
func FlattenResourceKubeControllerManagerConfig(in kopsv1alpha2.KubeControllerManagerConfig) map[string]interface{} {
	out := map[string]interface{}{}
