...
func ExpandResourceKubeDNSConfig(in map[string]interface{}) kopsv1alpha2.KubeDNSConfig {
	if in == nil {
...
func FlattenResourceKubeDNSConfigInto(in kopsv1alpha2.KubeDNSConfig, out map[string]interface{}) {
...
func FlattenResourceKubeDNSConfig(in kopsv1alpha2.KubeDNSConfig) map[string]interface{} {
