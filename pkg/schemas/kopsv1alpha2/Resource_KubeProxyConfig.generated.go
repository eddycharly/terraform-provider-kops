...
func ExpandResourceKubeProxyConfig(in map[string]interface{}) kopsv1alpha2.KubeProxyConfig {
	if in == nil {
...
func FlattenResourceKubeProxyConfigInto(in kopsv1alpha2.KubeProxyConfig, out map[string]interface{}) {
...
func FlattenResourceKubeProxyConfig(in kopsv1alpha2.KubeProxyConfig) map[string]interface{} {
	out := map[string]interface{}{}
