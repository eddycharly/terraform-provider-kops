...
func ExpandResourceKubeSchedulerConfig(in map[string]interface{}) kopsv1alpha2.KubeSchedulerConfig {
	if in == nil {
...
func FlattenResourceKubeSchedulerConfigInto(in kopsv1alpha2.KubeSchedulerConfig, out map[string]interface{}) {
...
func FlattenResourceKubeSchedulerConfig(in kopsv1alpha2.KubeSchedulerConfig) map[string]interface{} {
	out := map[string]interface{}{}
