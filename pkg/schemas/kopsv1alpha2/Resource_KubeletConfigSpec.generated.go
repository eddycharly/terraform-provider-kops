...
func ExpandResourceKubeletConfigSpec(in map[string]interface{}) kopsv1alpha2.KubeletConfigSpec {
	if in == nil {
...
func FlattenResourceKubeletConfigSpecInto(in kopsv1alpha2.KubeletConfigSpec, out map[string]interface{}) {
...
func FlattenResourceKubeletConfigSpec(in kopsv1alpha2.KubeletConfigSpec) map[string]interface{} {
	out := map[string]interface{}{}
