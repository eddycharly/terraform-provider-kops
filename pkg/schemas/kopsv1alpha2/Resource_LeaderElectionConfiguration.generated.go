...
func ExpandResourceLeaderElectionConfiguration(in map[string]interface{}) kopsv1alpha2.LeaderElectionConfiguration {
	if in == nil {
...
func FlattenResourceLeaderElectionConfigurationInto(in kopsv1alpha2.LeaderElectionConfiguration, out map[string]interface{}) {
...
func FlattenResourceLeaderElectionConfiguration(in kopsv1alpha2.LeaderElectionConfiguration) map[string]interface{} {
