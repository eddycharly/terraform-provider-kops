...
func ExpandResourceLoadBalancerAccessSpec(in map[string]interface{}) kopsv1alpha2.LoadBalancerAccessSpec {
	if in == nil {
...
func FlattenResourceLoadBalancerAccessSpecInto(in kopsv1alpha2.LoadBalancerAccessSpec, out map[string]interface{}) {
...
func FlattenResourceLoadBalancerAccessSpec(in kopsv1alpha2.LoadBalancerAccessSpec) map[string]interface{} {
