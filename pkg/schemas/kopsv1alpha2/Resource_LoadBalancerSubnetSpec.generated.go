...
func ExpandResourceLoadBalancerSubnetSpec(in map[string]interface{}) kopsv1alpha2.LoadBalancerSubnetSpec {
	if in == nil {
...
func FlattenResourceLoadBalancerSubnetSpecInto(in kopsv1alpha2.LoadBalancerSubnetSpec, out map[string]interface{}) {
...
func FlattenResourceLoadBalancerSubnetSpec(in kopsv1alpha2.LoadBalancerSubnetSpec) map[string]interface{} {
