...
func ExpandResourceMixedInstancesPolicySpec(in map[string]interface{}) kopsv1alpha2.MixedInstancesPolicySpec {
	if in == nil {
...
func FlattenResourceMixedInstancesPolicySpecInto(in kopsv1alpha2.MixedInstancesPolicySpec, out map[string]interface{}) {
...
func FlattenResourceMixedInstancesPolicySpec(in kopsv1alpha2.MixedInstancesPolicySpec) map[string]interface{} {
