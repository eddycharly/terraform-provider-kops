...
func ExpandResourceNodeAuthorizerSpec(in map[string]interface{}) kopsv1alpha2.NodeAuthorizerSpec {
	if in == nil {
...
func FlattenResourceNodeAuthorizerSpecInto(in kopsv1alpha2.NodeAuthorizerSpec, out map[string]interface{}) {
...
func FlattenResourceNodeAuthorizerSpec(in kopsv1alpha2.NodeAuthorizerSpec) map[string]interface{} {
