...
func ExpandResourceNodeLocalDNSConfig(in map[string]interface{}) kopsv1alpha2.NodeLocalDNSConfig {
	if in == nil {
...
func FlattenResourceNodeLocalDNSConfigInto(in kopsv1alpha2.NodeLocalDNSConfig, out map[string]interface{}) {
...
func FlattenResourceNodeLocalDNSConfig(in kopsv1alpha2.NodeLocalDNSConfig) map[string]interface{} {
	out := map[string]interface{}{}
