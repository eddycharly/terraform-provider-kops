...
func ExpandResourceNodeProblemDetectorConfig(in map[string]interface{}) kopsv1alpha2.NodeProblemDetectorConfig {
	if in == nil {
...
func FlattenResourceNodeProblemDetectorConfigInto(in kopsv1alpha2.NodeProblemDetectorConfig, out map[string]interface{}) {
...
func FlattenResourceNodeProblemDetectorConfig(in kopsv1alpha2.NodeProblemDetectorConfig) map[string]interface{} {
