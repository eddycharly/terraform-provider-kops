...
func ExpandResourceNodeTerminationHandlerSpec(in map[string]interface{}) kopsv1alpha2.NodeTerminationHandlerSpec {
	if in == nil {
...
func FlattenResourceNodeTerminationHandlerSpecInto(in kopsv1alpha2.NodeTerminationHandlerSpec, out map[string]interface{}) {
...
func FlattenResourceNodeTerminationHandlerSpec(in kopsv1alpha2.NodeTerminationHandlerSpec) map[string]interface{} {
