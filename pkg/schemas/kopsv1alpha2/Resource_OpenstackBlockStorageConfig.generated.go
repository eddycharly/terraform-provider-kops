...
func ExpandResourceOpenstackBlockStorageConfig(in map[string]interface{}) kopsv1alpha2.OpenstackBlockStorageConfig {
	if in == nil {
...
func FlattenResourceOpenstackBlockStorageConfigInto(in kopsv1alpha2.OpenstackBlockStorageConfig, out map[string]interface{}) {
...
func FlattenResourceOpenstackBlockStorageConfig(in kopsv1alpha2.OpenstackBlockStorageConfig) map[string]interface{} {
