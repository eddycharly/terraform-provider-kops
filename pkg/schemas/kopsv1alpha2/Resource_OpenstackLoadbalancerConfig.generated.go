...
func ExpandResourceOpenstackLoadbalancerConfig(in map[string]interface{}) kopsv1alpha2.OpenstackLoadbalancerConfig {
	if in == nil {
...
func FlattenResourceOpenstackLoadbalancerConfigInto(in kopsv1alpha2.OpenstackLoadbalancerConfig, out map[string]interface{}) {
...
func FlattenResourceOpenstackLoadbalancerConfig(in kopsv1alpha2.OpenstackLoadbalancerConfig) map[string]interface{} {
