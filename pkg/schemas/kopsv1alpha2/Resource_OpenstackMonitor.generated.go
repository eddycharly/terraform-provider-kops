...
func ExpandResourceOpenstackMonitor(in map[string]interface{}) kopsv1alpha2.OpenstackMonitor {
	if in == nil {
...
func FlattenResourceOpenstackMonitorInto(in kopsv1alpha2.OpenstackMonitor, out map[string]interface{}) {
...
func FlattenResourceOpenstackMonitor(in kopsv1alpha2.OpenstackMonitor) map[string]interface{} {
