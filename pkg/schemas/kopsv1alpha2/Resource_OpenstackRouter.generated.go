...
func ExpandResourceOpenstackRouter(in map[string]interface{}) kopsv1alpha2.OpenstackRouter {
	if in == nil {
...
func FlattenResourceOpenstackRouterInto(in kopsv1alpha2.OpenstackRouter, out map[string]interface{}) {
...
func FlattenResourceOpenstackRouter(in kopsv1alpha2.OpenstackRouter) map[string]interface{} {
