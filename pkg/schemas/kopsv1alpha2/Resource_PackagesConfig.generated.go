...
func ExpandResourcePackagesConfig(in map[string]interface{}) kopsv1alpha2.PackagesConfig {
	if in == nil {
...
func FlattenResourcePackagesConfigInto(in kopsv1alpha2.PackagesConfig, out map[string]interface{}) {
...
func FlattenResourcePackagesConfig(in kopsv1alpha2.PackagesConfig) map[string]interface{} {
