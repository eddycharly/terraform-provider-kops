...
func ExpandResourceRouteSpec(in map[string]interface{}) kopsv1alpha2.RouteSpec {
	if in == nil {
...
func FlattenResourceRouteSpecInto(in kopsv1alpha2.RouteSpec, out map[string]interface{}) {
...
func FlattenResourceRouteSpec(in kopsv1alpha2.RouteSpec) map[string]interface{} {
