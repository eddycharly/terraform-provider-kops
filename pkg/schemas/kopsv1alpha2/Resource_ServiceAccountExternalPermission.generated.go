...
func ExpandResourceServiceAccountExternalPermission(in map[string]interface{}) kopsv1alpha2.ServiceAccountExternalPermission {
	if in == nil {
...
func FlattenResourceServiceAccountExternalPermissionInto(in kopsv1alpha2.ServiceAccountExternalPermission, out map[string]interface{}) {
...
func FlattenResourceServiceAccountExternalPermission(in kopsv1alpha2.ServiceAccountExternalPermission) map[string]interface{} {
