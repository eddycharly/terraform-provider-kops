...
func ExpandResourceServiceAccountIssuerDiscoveryConfig(in map[string]interface{}) kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig {
	if in == nil {
...
func FlattenResourceServiceAccountIssuerDiscoveryConfigInto(in kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig, out map[string]interface{}) {
...
func FlattenResourceServiceAccountIssuerDiscoveryConfig(in kopsv1alpha2.ServiceAccountIssuerDiscoveryConfig) map[string]interface{} {
