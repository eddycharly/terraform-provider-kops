...
func ExpandResourceSnapshotControllerConfig(in map[string]interface{}) kopsv1alpha2.SnapshotControllerConfig {
	if in == nil {
...
func FlattenResourceSnapshotControllerConfigInto(in kopsv1alpha2.SnapshotControllerConfig, out map[string]interface{}) {
...
func FlattenResourceSnapshotControllerConfig(in kopsv1alpha2.SnapshotControllerConfig) map[string]interface{} {
