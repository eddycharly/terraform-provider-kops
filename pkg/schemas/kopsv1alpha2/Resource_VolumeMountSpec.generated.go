...
func ExpandResourceVolumeMountSpec(in map[string]interface{}) kopsv1alpha2.VolumeMountSpec {
	if in == nil {
...
func FlattenResourceVolumeMountSpecInto(in kopsv1alpha2.VolumeMountSpec, out map[string]interface{}) {
...
func FlattenResourceVolumeMountSpec(in kopsv1alpha2.VolumeMountSpec) map[string]interface{} {
