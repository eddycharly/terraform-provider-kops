...
func ExpandResourceVolumeSpec(in map[string]interface{}) kopsv1alpha2.VolumeSpec {
	if in == nil {
...
func FlattenResourceVolumeSpecInto(in kopsv1alpha2.VolumeSpec, out map[string]interface{}) {
...
func FlattenResourceVolumeSpec(in kopsv1alpha2.VolumeSpec) map[string]interface{} {
