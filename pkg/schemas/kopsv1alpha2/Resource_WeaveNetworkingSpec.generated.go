...
func ExpandResourceWeaveNetworkingSpec(in map[string]interface{}) kopsv1alpha2.WeaveNetworkingSpec {
	if in == nil {
...
func FlattenResourceWeaveNetworkingSpecInto(in kopsv1alpha2.WeaveNetworkingSpec, out map[string]interface{}) {
...
func FlattenResourceWeaveNetworkingSpec(in kopsv1alpha2.WeaveNetworkingSpec) map[string]interface{} {
