...
func ExpandDataSourceLabelSelector(in map[string]interface{}) v1.LabelSelector {
	if in == nil {
...
func FlattenDataSourceLabelSelectorInto(in v1.LabelSelector, out map[string]interface{}) {
...
func FlattenDataSourceLabelSelector(in v1.LabelSelector) map[string]interface{} {
	out := map[string]interface{}{}
