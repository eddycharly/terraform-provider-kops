			...
			args: args{
				in: map[string]interface{}{
					...
					"networking": func() []interface{} {
						return []interface{}{kopsv1alpha2schemas.FlattenResourceNetworkingSpec(kopsv1alpha2.NetworkingSpec{})}
					}(),
					"legacy_api": nil,
					"api": func() []interface{} {
						return []interface{}{kopsv1alpha2schemas.FlattenResourceAPISpec(kopsv1alpha2.APISpec{})}
					}(),
					"authentication":                   nil,
					"authorization":                    nil,
