...
func ResourceInstanceGroup() *schema.Resource {
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"root_volume_size":                  OptionalComputedInt(),
			"root_volume_type":                  OptionalComputedString(),
			"root_volume_iops":                  OptionalComputedInt(),
			"root_volume_optimization":          OptionalComputedBool(),
			"root_volume_delete_on_termination": OptionalComputedBool(),
			"root_volume_encryption":            OptionalComputedBool(),
